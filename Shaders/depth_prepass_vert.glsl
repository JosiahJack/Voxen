...
out vec3 FragPos; out vec2 TexCoord;
void main() { TexCoord = aTexCoord; vec4 worldPos = modelMatrices[instanceIndex] * vec4(aPos,1.0); gl_Position = viewProjection * worldPos; FragPos = vec3(worldPos); }
