...
ENGINE_TO_MOD bool SndPlaying(wav_channel_t* sound);
...
ENGINE_TO_MOD void SoundSetLooping(wav_channel_t* pSound, bool loop);
ENGINE_TO_MOD void SndSetVolume(wav_channel_t* pSound, float volume);
ENGINE_TO_MOD i32 SndStart(wav_channel_t* pSound);
ENGINE_TO_MOD void SndStop(wav_channel_t* pSound);
ENGINE_TO_MOD float SndLen(wav_channel_t* pSound);
ENGINE_TO_MOD i32 SndFrmCurpos(wav_channel_t* pSound, u64* pCursor);
