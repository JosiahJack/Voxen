...
MOD_TO_ENGINE void ModEntityDefinitionsInitAfterLoad(void) { // Global conditions for all entities.  No sense inflating the table data in entity.c
    ...
    CopyMemoryFromBtoAForNBytes(EDefs[241].path,"chunk_sci1_1", 13); EDefs[241].modelIndex=540; EDefs[241].cardchunk=true;  EDefs[241].texIndex=722; 
    ...
    CopyMemoryFromBtoAForNBytes(EDefs[252].path,"chunk_sci1_4",13); EDefs[252].modelIndex=498; EDefs[252].cardchunk=true;  EDefs[252].texIndex=727; 
