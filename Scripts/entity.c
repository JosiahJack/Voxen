...
MOD_TO_ENGINE void ModEntityDefinitionsInitAfterLoad(void) { // Global conditions for all entities.  No sense inflating the table data in entity.c
    ...
    /*309 item_beaker*/     EDefs[309].modelIndex=14; EDefs[309].collider=COLTYPE_CVX;  EDefs[309].colliderMeshIndex=682;  EDefs[309].texIndex=36;  EDefs[309].specIndex=1242;  EDefs[309].mass=0.28f; EDefs[309].angularDrag=0.05f; EDefs[309].dynamicFriction=0.6f;  EDefs[309].staticFriction=0.6f;
    /*310 item_beverage*/   EDefs[310].modelIndex=18;  EDefs[310].collider=COLTYPE_CVX;  EDefs[310].colliderMeshIndex=683;  EDefs[310].texIndex=37;  EDefs[310].mass=0.12f; EDefs[310].angularDrag=0.05f; EDefs[310].dynamicFriction=0.6f;  EDefs[310].staticFriction=0.6f;
    /*311 item_skull*/ EDefs[311].modelIndex=593;  EDefs[311].mass=0.451f; EDefs[311].angularDrag=0.05f; EDefs[311].dynamicFriction=0.6f;  EDefs[311].staticFriction=0.6f;
    /*312 item_arm*/ EDefs[312].modelIndex=7;  EDefs[312].texIndex=28;  EDefs[312].collider=COLTYPE_CVX;  EDefs[312].colliderMeshIndex=678;  EDefs[312].mass=1.0f; EDefs[312].angularDrag=0.05f; EDefs[312].dynamicFriction=0.6f;  EDefs[312].staticFriction=0.6f;
    /*313 item_audiolog*/ EDefs[313].modelIndex=11;  EDefs[313].collider=COLTYPE_CVX;  EDefs[313].colliderMeshIndex=679;  EDefs[313].texIndex=52;  EDefs[313].glowIndex=80;  EDefs[313].mass=0.2f; EDefs[313].angularDrag=0.05f; EDefs[313].dynamicFriction=0.6f;  EDefs[313].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[314].path,"weapon_grenadefrag",19); EDefs[314].modelIndex=182;  EDefs[314].mass=1.0f; EDefs[314].angularDrag=0.05f; EDefs[314].dynamicFriction=0.6f;  EDefs[314].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[315].path,"weapon_grenadeconc",19); EDefs[315].modelIndex=165;  EDefs[315].mass=1.0f; EDefs[315].angularDrag=0.05f; EDefs[315].dynamicFriction=0.6f;  EDefs[315].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[316].path,"weapon_grenadeemp",18); EDefs[316].modelIndex=168;  EDefs[316].mass=1.0f; EDefs[316].angularDrag=0.05f; EDefs[316].dynamicFriction=0.6f;  EDefs[316].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[317].path,"weapon_grenadeearth",20); EDefs[317].modelIndex=181;  EDefs[317].mass=1.0f; EDefs[317].angularDrag=0.05f; EDefs[317].dynamicFriction=0.6f;  EDefs[317].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[318].path,"weapon_grenademine",19); EDefs[318].modelIndex=184;  EDefs[318].mass=1.0f; EDefs[318].angularDrag=0.05f; EDefs[318].dynamicFriction=0.6f;  EDefs[318].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[319].path,"weapon_grenadenitro",20); EDefs[319].modelIndex=185;  EDefs[319].mass=1.0f; EDefs[319].angularDrag=0.05f; EDefs[319].dynamicFriction=0.6f;  EDefs[319].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[320].path,"weapon_grenadegas",18); EDefs[320].modelIndex=183;  EDefs[320].mass=1.0f; EDefs[320].angularDrag=0.05f; EDefs[320].dynamicFriction=0.6f;  EDefs[320].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[321].path,"item_patch_berserk",19); EDefs[321].modelIndex=488;  EDefs[321].collider=COLTYPE_CVX;  EDefs[321].colliderMeshIndex=491;  EDefs[321].texIndex=590;  EDefs[321].mass=0.12f; EDefs[321].angularDrag=0.05f; EDefs[321].dynamicFriction=0.6f;  EDefs[321].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[322].path,"item_patch_detox",17); EDefs[322].modelIndex=488;  EDefs[322].collider=COLTYPE_CVX;  EDefs[322].colliderMeshIndex=491;  EDefs[322].texIndex=591;  EDefs[322].mass=0.12f; EDefs[322].angularDrag=0.05f; EDefs[322].dynamicFriction=0.6f;  EDefs[322].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[323].path,"item_patch_genius",18); EDefs[323].modelIndex=488;  EDefs[323].collider=COLTYPE_CVX;  EDefs[323].colliderMeshIndex=491;  EDefs[323].texIndex=592;  EDefs[323].mass=0.12f; EDefs[323].angularDrag=0.05f; EDefs[323].dynamicFriction=0.6f;  EDefs[323].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[324].path,"item_patch_medi",16); EDefs[324].modelIndex=488;  EDefs[324].collider=COLTYPE_CVX;  EDefs[324].colliderMeshIndex=491;  EDefs[324].texIndex=600;  EDefs[324].mass=0.12f; EDefs[324].angularDrag=0.05f; EDefs[324].dynamicFriction=0.6f;  EDefs[324].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[325].path,"item_patch_reflex",18); EDefs[325].modelIndex=488;  EDefs[325].collider=COLTYPE_CVX;  EDefs[325].colliderMeshIndex=491;  EDefs[325].texIndex=641;  EDefs[325].mass=0.12f;  EDefs[325].angularDrag=0.05f; EDefs[325].dynamicFriction=0.6f;  EDefs[325].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[326].path,"item_patch_sight",17); EDefs[326].modelIndex=488;  EDefs[326].collider=COLTYPE_CVX;  EDefs[326].colliderMeshIndex=491;  EDefs[326].texIndex=646;  EDefs[326].mass=0.12f;  EDefs[326].angularDrag=0.05f; EDefs[326].dynamicFriction=0.6f;  EDefs[326].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[327].path,"item_patch_staminup",20); EDefs[327].modelIndex=488;  EDefs[327].collider=COLTYPE_CVX;  EDefs[327].colliderMeshIndex=491;  EDefs[327].texIndex=647;  EDefs[327].mass=0.12f; EDefs[327].angularDrag=0.05f; EDefs[327].dynamicFriction=0.6f;  EDefs[327].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[328].path,"item_hw_system",15); EDefs[328].modelIndex=207;  EDefs[328].texIndex=405;  EDefs[328].glowIndex=404;  EDefs[328].mass=0.17f;  EDefs[328].angularDrag=0.05f; EDefs[328].dynamicFriction=0.6f;  EDefs[328].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[329].path,"item_hw_navunit",16); EDefs[329].modelIndex=204;  EDefs[329].collider=COLTYPE_CVX;  EDefs[329].colliderMeshIndex=696;  EDefs[329].texIndex=1258;  EDefs[329].glowIndex=1259;  EDefs[329].mass=0.1f; EDefs[329].angularDrag=0.05f; EDefs[329].dynamicFriction=0.6f;  EDefs[329].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[330].path,"item_hw_ereader",16); EDefs[330].modelIndex=200;  EDefs[330].collider=COLTYPE_CVX;  EDefs[330].colliderMeshIndex=692;  EDefs[330].mass=0.12f;  EDefs[330].angularDrag=0.05f; EDefs[330].dynamicFriction=0.6f;  EDefs[330].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[331].path,"item_hw_sensaround",19); EDefs[331].modelIndex=205;  EDefs[331].collider=COLTYPE_CVX;  EDefs[331].colliderMeshIndex=697;  EDefs[331].mass=0.12f; EDefs[331].angularDrag=0.05f; EDefs[331].dynamicFriction=0.6f;  EDefs[331].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[332].path,"item_hw_targetid",17); EDefs[332].modelIndex=208;  EDefs[332].mass=0.08f;  EDefs[332].angularDrag=0.05f; EDefs[332].dynamicFriction=0.6f;  EDefs[332].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[333].path,"item_hw_shield",15); EDefs[333].modelIndex=206;  EDefs[333].mass=0.14f;  EDefs[333].angularDrag=0.05f; EDefs[333].dynamicFriction=0.6f;  EDefs[333].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[334].path,"item_hw_bio",12); EDefs[334].modelIndex=197;  EDefs[334].collider=COLTYPE_CVX;  EDefs[334].colliderMeshIndex=689;  EDefs[334].mass=0.1f;   EDefs[334].angularDrag=0.05f; EDefs[334].dynamicFriction=0.6f;  EDefs[334].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[335].path,"item_hw_lantern",16); EDefs[335].modelIndex=203;  EDefs[335].collider=COLTYPE_CVX;  EDefs[335].colliderMeshIndex=695;  EDefs[335].mass=0.11f;  EDefs[335].angularDrag=0.05f; EDefs[335].dynamicFriction=0.6f;  EDefs[335].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[336].path,"item_hw_envirosuit",19); EDefs[336].modelIndex=199;  EDefs[336].collider=COLTYPE_CVX;  EDefs[336].colliderMeshIndex=691;  EDefs[336].mass=0.451f;   EDefs[336].angularDrag=0.05f; EDefs[336].dynamicFriction=0.6f;  EDefs[336].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[337].path,"item_hw_booster",16); EDefs[337].modelIndex=198;  EDefs[337].collider=COLTYPE_CVX;  EDefs[337].colliderMeshIndex=690;  EDefs[337].mass=0.16f;  EDefs[337].angularDrag=0.05f; EDefs[337].dynamicFriction=0.6f;  EDefs[337].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[338].path,"item_hw_jumpjets",17); EDefs[338].modelIndex=202;  EDefs[338].collider=COLTYPE_CVX;  EDefs[338].colliderMeshIndex=694;  EDefs[338].mass=0.32f; EDefs[338].angularDrag=0.05f;  EDefs[338].dynamicFriction=0.6f;  EDefs[338].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[339].path,"item_hw_infrared",17); EDefs[339].modelIndex=201;  EDefs[339].collider=COLTYPE_CVX;  EDefs[339].colliderMeshIndex=693;  EDefs[339].mass=0.1f; EDefs[339].angularDrag=0.05f;  EDefs[339].dynamicFriction=0.6f;  EDefs[339].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[340].path,"item_fireextinguisher",22); EDefs[340].modelIndex=144;  EDefs[340].collider=COLTYPE_CVX;  EDefs[340].colliderMeshIndex=684;  EDefs[340].mass=1.3f; EDefs[340].angularDrag=0.05f; EDefs[340].dynamicFriction=0.6f;  EDefs[340].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[341].path,"item_access_card_admin",23); EDefs[341].modelIndex=0;  EDefs[341].texIndex=9;  EDefs[341].glowIndex=82;  EDefs[341].collider=COLTYPE_CVX;  EDefs[341].colliderMeshIndex=672;  EDefs[341].mass=0.2f;  EDefs[341].angularDrag=0.05f; EDefs[341].dynamicFriction=0.6f;  EDefs[341].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[342].path,"item_workerhelmet",18); EDefs[342].modelIndex=648;  EDefs[342].mass=1.2f;  EDefs[342].angularDrag=0.05f; EDefs[342].dynamicFriction=0.6f;  EDefs[342].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[343].path,"weapon_mk3",11); EDefs[343].modelIndex=646;  EDefs[343].mass=0.75f;  EDefs[343].angularDrag=0.05f; EDefs[343].dynamicFriction=0.6f;  EDefs[343].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[344].path,"weapon_blaster",15); EDefs[344].modelIndex=638;  EDefs[344].mass=0.5f;  EDefs[344].angularDrag=0.05f;  EDefs[344].gravity=1.0f; EDefs[344].dynamicFriction=0.6f;  EDefs[344].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[345].path,"weapon_dartgun",15); EDefs[345].modelIndex=640;  EDefs[345].texIndex=876;  EDefs[345].mass=0.3f;  EDefs[345].angularDrag=0.05f; EDefs[345].dynamicFriction=0.6f;  EDefs[345].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[346].path,"weapon_flechette",17); EDefs[346].modelIndex=642;  EDefs[346].mass=0.4f; EDefs[346].angularDrag=0.05f; EDefs[346].dynamicFriction=0.6f;  EDefs[346].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[347].path,"weapon_ionrifle",16); EDefs[347].modelIndex=643;  EDefs[347].mass=0.8f; EDefs[347].angularDrag=0.05f; EDefs[347].dynamicFriction=0.6f;  EDefs[347].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[348].path,"weapon_rapier",14); EDefs[348].modelIndex=653;  EDefs[348].mass=0.3f;  EDefs[348].angularDrag=0.05f; EDefs[348].dynamicFriction=0.6f;  EDefs[348].staticFriction=0.6f;
    /*weapon_pipe*/                EDefs[349].modelIndex=649;  EDefs[349].texIndex=887;  EDefs[349].mass=0.85f; EDefs[349].angularDrag=0.05f;  EDefs[349].dynamicFriction=0.6f;  EDefs[349].staticFriction=0.6f;
    /*weapon_magnum*/              EDefs[350].modelIndex=644;  EDefs[350].mass=0.6f; EDefs[350].angularDrag=0.05f; EDefs[350].dynamicFriction=0.6f;  EDefs[350].staticFriction=0.6f;
    /*weapon_magpulse*/            EDefs[351].modelIndex=645;  EDefs[351].mass=0.65f; EDefs[351].angularDrag=0.05f; EDefs[351].dynamicFriction=0.6f;  EDefs[351].staticFriction=0.6f;
    /*weapon_pistol*/              EDefs[352].modelIndex=650;  EDefs[352].texIndex=878;  EDefs[352].mass=0.3f; EDefs[352].angularDrag=0.05f; EDefs[352].dynamicFriction=0.6f;  EDefs[352].staticFriction=0.6f;
    /*weapon_plasma*/              EDefs[353].modelIndex=651;  EDefs[353].mass=1.2f; EDefs[353].angularDrag=0.05f; EDefs[353].dynamicFriction=0.6f;  EDefs[353].staticFriction=0.6f;
    /*weapon_railgun*/             EDefs[354].modelIndex=652;  EDefs[354].mass=1.0f; EDefs[354].angularDrag=0.05f; EDefs[354].dynamicFriction=0.6f;  EDefs[354].staticFriction=0.6f;
    /*weapon_riotgun*/             EDefs[355].modelIndex=654;  EDefs[355].mass=0.55f; EDefs[355].angularDrag=0.05f; EDefs[355].dynamicFriction=0.6f;  EDefs[355].staticFriction=0.6f;
    /*weapon_skorpion*/            EDefs[356].modelIndex=655;  EDefs[356].mass=1.3f;  EDefs[356].angularDrag=0.05f; EDefs[356].dynamicFriction=0.6f;  EDefs[356].staticFriction=0.6f;
    /*weapon_sparqbeam*/           EDefs[357].modelIndex=656;  EDefs[357].mass=0.3f; EDefs[357].angularDrag=0.05f; EDefs[357].dynamicFriction=0.6f;  EDefs[357].staticFriction=0.6f;
    /*weapon_stungun*/             EDefs[358].modelIndex=657;  EDefs[358].mass=0.3f; EDefs[358].angularDrag=0.05f; EDefs[358].dynamicFriction=0.6f;  EDefs[358].staticFriction=0.6f;
    /*item_battery*/               EDefs[359].modelIndex=13;  EDefs[359].collider=COLTYPE_CVX;  EDefs[359].colliderMeshIndex=680;  EDefs[359].mass=0.3f; EDefs[359].angularDrag=0.05f;  EDefs[359].gravity=1.0f;  EDefs[359].kinematic=false;  EDefs[359].dynamicFriction=0.6f;  EDefs[359].staticFriction=0.6f;  EDefs[359].bounciness=0.0f;  EDefs[359].frictionCombine=PHYS_COMBINE_AVG;  EDefs[359].bounceCombine=PHYS_COMBINE_AVG; 
    /*item_battery_icad*/          EDefs[360].modelIndex=13;  EDefs[360].collider=COLTYPE_CVX;  EDefs[360].colliderMeshIndex=680;  EDefs[360].mass=0.35f;  EDefs[360].angularDrag=0.05f;  EDefs[360].gravity=1.0f;  EDefs[360].kinematic=false;  EDefs[360].dynamicFriction=0.6f;  EDefs[360].staticFriction=0.6f;  EDefs[360].bounciness=0.0f;  EDefs[360].frictionCombine=PHYS_COMBINE_AVG;  EDefs[360].bounceCombine=PHYS_COMBINE_AVG; 
    ...
    /*item_healthkit*/             EDefs[362].modelIndex=196; EDefs[362].collider=COLTYPE_CVX;  EDefs[362].colliderMeshIndex=688;  EDefs[362].mass=0.25f;  EDefs[362].angularDrag=0.05f;  EDefs[362].gravity=1.0f;  EDefs[362].kinematic=false;  EDefs[362].dynamicFriction=0.6f;  EDefs[362].staticFriction=0.6f;  EDefs[362].bounciness=0.0f;  EDefs[362].frictionCombine=PHYS_COMBINE_AVG;  EDefs[362].bounceCombine=PHYS_COMBINE_AVG; 
    ...
    /*item_chipset_interfacedemod*/EDefs[364].modelIndex=45;  EDefs[364].collider=COLTYPE_BOX;  EDefs[364].colliderCenter=(Vector3){0.003744498f,0.0001704991f,0.03192701f};  EDefs[364].colliderSize=(Vector3){0.459303f,0.3412231f,0.06385402f};  EDefs[364].colliderMeshIndex=U16_MAX;  EDefs[364].mass=0.3f;  EDefs[364].angularDrag=0.05f;  EDefs[364].gravity=1.0f;  EDefs[364].kinematic=false;  EDefs[364].dynamicFriction=0.6f;  EDefs[364].staticFriction=0.6f;  EDefs[364].bounciness=0.0f;  EDefs[364].frictionCombine=PHYS_COMBINE_AVG;  EDefs[364].bounceCombine=PHYS_COMBINE_AVG; 
    /*item_flask*/                 EDefs[365].modelIndex=145;  EDefs[365].collider=COLTYPE_CVX;  EDefs[365].colliderMeshIndex=685;  EDefs[365].texIndex=36;  EDefs[365].specIndex=1242;  EDefs[365].mass=0.22f;  EDefs[365].angularDrag=0.05f;  EDefs[365].gravity=1.0f;  EDefs[365].kinematic=false;  EDefs[365].dynamicFriction=0.6f;  EDefs[365].staticFriction=0.6f;  EDefs[365].bounciness=0.0f;  EDefs[365].frictionCombine=PHYS_COMBINE_AVG;  EDefs[365].bounceCombine=PHYS_COMBINE_AVG; 
    /*item_chipset_bitflag*/       EDefs[366].modelIndex=45;  EDefs[366].collider=COLTYPE_BOX;  EDefs[366].colliderCenter=(Vector3){0.003744498f,0.0001704991f,0.03192701f};  EDefs[366].colliderSize=(Vector3){0.459303f,0.3412231f,0.06385402f};  EDefs[366].colliderMeshIndex=U16_MAX;  EDefs[366].mass=0.3f;  EDefs[366].angularDrag=0.05f;  EDefs[366].gravity=1.0f;  EDefs[366].kinematic=false;  EDefs[366].dynamicFriction=0.6f;  EDefs[366].staticFriction=0.6f;  EDefs[366].bounciness=0.0f;  EDefs[366].frictionCombine=PHYS_COMBINE_AVG;  EDefs[366].bounceCombine=PHYS_COMBINE_AVG; 
    /*item_ammo_rubber*/           EDefs[367].modelIndex=8; EDefs[367].collider=COLTYPE_CVX;  EDefs[367].colliderMeshIndex=676;  EDefs[367].mass=0.25f;  EDefs[367].angularDrag=0.05f;  EDefs[367].gravity=1.0f;  EDefs[367].kinematic=false;  EDefs[367].dynamicFriction=0.6f;  EDefs[367].staticFriction=0.6f;  EDefs[367].bounciness=0.0f;  EDefs[367].frictionCombine=PHYS_COMBINE_AVG;  EDefs[367].bounceCombine=PHYS_COMBINE_AVG; 
    /*item_isotopex22*/            EDefs[368].modelIndex=209;  EDefs[368].mass=1.2f;  EDefs[368].angularDrag=0.05f;  EDefs[368].gravity=1.0f;  EDefs[368].kinematic=false;  EDefs[368].dynamicFriction=0.6f;  EDefs[368].staticFriction=0.6f;
    /*item_testtube*/              EDefs[369].modelIndex=622; EDefs[369].texIndex=36; EDefs[369].specIndex=1242; EDefs[369].collider=COLTYPE_CVX; EDefs[369].colliderMeshIndex=612; EDefs[369].mass=0.21f; EDefs[369].angularDrag=0.05f; EDefs[369].gravity=1.0f; EDefs[369].dynamicFriction=0.6f; EDefs[369].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[370].path,"weapon_grenadefrag_live",24); EDefs[370].modelIndex=182;  EDefs[370].mass=1.0f;   EDefs[370].angularDrag=0.05f;  EDefs[370].gravity=1.0f;  EDefs[370].kinematic=false;  EDefs[370].dynamicFriction=0.6f;  EDefs[370].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[371].path,"item_chipset_isolinear",23); EDefs[371].modelIndex=46;  EDefs[371].collider=COLTYPE_BOX;  EDefs[371].colliderCenter=(Vector3){-0.0009825006f,-0.0129465f,0.0148115f};  EDefs[371].colliderSize=(Vector3){0.223635f,0.4175691f,0.02912301f};  EDefs[371].colliderMeshIndex=U16_MAX;  EDefs[371].mass=0.26f;  EDefs[371].angularDrag=0.05f;  EDefs[371].gravity=1.0f;  EDefs[371].kinematic=false;  EDefs[371].dynamicFriction=0.6f;  EDefs[371].staticFriction=0.6f;  EDefs[371].bounciness=0.0f;  EDefs[371].frictionCombine=PHYS_COMBINE_AVG;  EDefs[371].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[372].path,"weapon_grenadeconc_live",24); EDefs[372].modelIndex=165;  EDefs[372].mass=1.0f; EDefs[372].angularDrag=0.05f;  EDefs[372].gravity=1.0f;  EDefs[372].kinematic=false;  EDefs[372].dynamicFriction=0.6f;  EDefs[372].staticFriction=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[373].path,"item_ammo_needle",17); EDefs[373].modelIndex=4;  EDefs[373].texIndex=15;  EDefs[373].collider=COLTYPE_BOX;  EDefs[373].colliderCenter=(Vector3){-0.0004654949f,0.0004549972f,0.0244365f};  EDefs[373].colliderSize=(Vector3){0.131339f,0.1442801f,0.04838703f};  EDefs[373].colliderMeshIndex=U16_MAX;  EDefs[373].mass=0.15f;  EDefs[373].angularDrag=0.05f;  EDefs[373].gravity=1.0f;  EDefs[373].kinematic=false;  EDefs[373].dynamicFriction=0.6f;  EDefs[373].staticFriction=0.6f;  EDefs[373].bounciness=0.0f;  EDefs[373].frictionCombine=PHYS_COMBINE_AVG;  EDefs[373].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[374].path,"item_ammo_tranq",16); EDefs[374].modelIndex=4;  EDefs[374].texIndex=27;  EDefs[374].collider=COLTYPE_BOX;  EDefs[374].colliderCenter=(Vector3){-0.0004654949f,0.0004549972f,0.0244365f};  EDefs[374].colliderSize=(Vector3){0.131339f,0.1442801f,0.04838703f};  EDefs[374].colliderMeshIndex=U16_MAX;  EDefs[374].mass=0.15f; EDefs[374].angularDrag=0.05f;  EDefs[374].gravity=1.0f;  EDefs[374].kinematic=false;  EDefs[374].dynamicFriction=0.6f;  EDefs[374].staticFriction=0.6f;  EDefs[374].bounciness=0.0f;  EDefs[374].frictionCombine=PHYS_COMBINE_AVG;  EDefs[374].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[375].path,"item_ammo_standard",19); EDefs[375].modelIndex=5;  EDefs[375].collider=COLTYPE_BOX;  EDefs[375].colliderCenter=(Vector3){0.0001984993f,0.0f,0.02172501f};  EDefs[375].colliderSize=(Vector3){0.1209471f,0.2176701f,0.04345007f};  EDefs[375].colliderMeshIndex=U16_MAX;  EDefs[375].mass=0.2f; EDefs[375].angularDrag=0.05f;  EDefs[375].gravity=1.0f;  EDefs[375].kinematic=false;  EDefs[375].dynamicFriction=0.6f;  EDefs[375].staticFriction=0.6f;  EDefs[375].bounciness=0.0f;  EDefs[375].frictionCombine=PHYS_COMBINE_AVG;  EDefs[375].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[376].path,"item_ammo_teflon",17); EDefs[376].modelIndex=5;  EDefs[376].collider=COLTYPE_BOX;  EDefs[376].colliderCenter=(Vector3){0.0001984993f,0.0f,0.02172501f};  EDefs[376].colliderSize=(Vector3){0.1209471f,0.2176701f,0.04345007f};  EDefs[376].colliderMeshIndex=U16_MAX;  EDefs[376].mass=0.2f; EDefs[376].angularDrag=0.05f;  EDefs[376].gravity=1.0f;  EDefs[376].kinematic=false;  EDefs[376].dynamicFriction=0.6f;  EDefs[376].staticFriction=0.6f;  EDefs[376].bounciness=0.0f;  EDefs[376].frictionCombine=PHYS_COMBINE_AVG;  EDefs[376].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[377].path,"item_ammo_hollow",17); EDefs[377].modelIndex=5;  EDefs[377].collider=COLTYPE_BOX;  EDefs[377].colliderCenter=(Vector3){0.0002185023f,0.0f,0.02122951f};  EDefs[377].colliderSize=(Vector3){0.1423431f,0.2127061f,0.04245907f};  EDefs[377].colliderMeshIndex=U16_MAX;  EDefs[377].mass=0.2f; EDefs[377].angularDrag=0.05f;  EDefs[377].gravity=1.0f;  EDefs[377].kinematic=false;  EDefs[377].dynamicFriction=0.6f;  EDefs[377].staticFriction=0.6f;  EDefs[377].bounciness=0.0f;  EDefs[377].frictionCombine=PHYS_COMBINE_AVG;  EDefs[377].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[378].path,"item_ammo_slug",15); EDefs[378].modelIndex=3;  EDefs[378].collider=COLTYPE_BOX;  EDefs[378].colliderCenter=(Vector3){0.0002185023f,0.0f,0.02122951f};  EDefs[378].colliderSize=(Vector3){0.1423431f,0.2127061f,0.04245907f};  EDefs[378].colliderMeshIndex=U16_MAX;  EDefs[378].glowIndex=22;  EDefs[378].mass=0.2f; EDefs[378].angularDrag=0.05f;  EDefs[378].gravity=1.0f;  EDefs[378].kinematic=false;  EDefs[378].dynamicFriction=0.6f;  EDefs[378].staticFriction=0.6f;  EDefs[378].bounciness=0.0f;  EDefs[378].frictionCombine=PHYS_COMBINE_AVG;  EDefs[378].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[379].path,"item_ammo_magnesium",20); EDefs[379].modelIndex=3;  EDefs[379].collider=COLTYPE_CVX;  EDefs[379].colliderMeshIndex=673;  EDefs[379].mass=0.35f; EDefs[379].angularDrag=0.05f;  EDefs[379].gravity=1.0f;  EDefs[379].kinematic=false;  EDefs[379].dynamicFriction=0.6f;  EDefs[379].staticFriction=0.6f;  EDefs[379].bounciness=0.0f;  EDefs[379].frictionCombine=PHYS_COMBINE_AVG;  EDefs[379].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[380].path,"item_ammo_penetrator",21); EDefs[380].modelIndex=3;  EDefs[380].collider=COLTYPE_CVX;  EDefs[380].colliderMeshIndex=673;  EDefs[380].mass=0.35f; EDefs[380].angularDrag=0.05f;  EDefs[380].gravity=1.0f;  EDefs[380].kinematic=false;  EDefs[380].dynamicFriction=0.6f;  EDefs[380].staticFriction=0.6f;  EDefs[380].bounciness=0.0f;  EDefs[380].frictionCombine=PHYS_COMBINE_AVG;  EDefs[380].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[381].path,"item_ammo_hornet",17); EDefs[381].modelIndex=1;  EDefs[381].collider=COLTYPE_CVX;  EDefs[381].colliderMeshIndex=673;  EDefs[381].mass=0.35f; EDefs[381].angularDrag=0.05f;  EDefs[381].gravity=1.0f;  EDefs[381].kinematic=false;  EDefs[381].dynamicFriction=0.6f;  EDefs[381].staticFriction=0.6f;  EDefs[381].bounciness=0.0f;  EDefs[381].frictionCombine=PHYS_COMBINE_AVG;  EDefs[381].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[382].path,"item_ammo_splinter",19); EDefs[382].modelIndex=630;  EDefs[382].collider=COLTYPE_CVX;  EDefs[382].colliderMeshIndex=673;  EDefs[382].mass=0.35f; EDefs[382].angularDrag=0.05f;  EDefs[382].gravity=1.0f;  EDefs[382].kinematic=false;  EDefs[382].dynamicFriction=0.6f;  EDefs[382].staticFriction=0.6f;  EDefs[382].bounciness=0.0f;  EDefs[382].frictionCombine=PHYS_COMBINE_AVG;  EDefs[382].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[383].path,"item_ammo_rail",15); EDefs[383].modelIndex=6;  EDefs[383].collider=COLTYPE_CVX;  EDefs[383].colliderMeshIndex=675;  EDefs[383].mass=0.4f; EDefs[383].angularDrag=0.05f;  EDefs[383].gravity=1.0f;  EDefs[383].kinematic=false;  EDefs[383].dynamicFriction=0.6f;  EDefs[383].staticFriction=0.6f;  EDefs[383].bounciness=0.0f;  EDefs[383].frictionCombine=PHYS_COMBINE_AVG;  EDefs[383].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[384].path,"item_ammo_slag",15); EDefs[384].modelIndex=9;  EDefs[384].collider=COLTYPE_CVX;  EDefs[384].colliderMeshIndex=673;  EDefs[384].mass=0.35f; EDefs[384].angularDrag=0.05f;  EDefs[384].gravity=1.0f;  EDefs[384].kinematic=false;  EDefs[384].dynamicFriction=0.6f;  EDefs[384].staticFriction=0.6f;  EDefs[384].bounciness=0.0f;  EDefs[384].frictionCombine=PHYS_COMBINE_AVG;  EDefs[384].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[385].path,"item_ammo_slaglarge",20); EDefs[385].modelIndex=10;  EDefs[385].collider=COLTYPE_CVX;  EDefs[385].colliderMeshIndex=677;  EDefs[385].mass=0.40f; EDefs[385].angularDrag=0.05f;  EDefs[385].gravity=1.0f;  EDefs[385].kinematic=false;  EDefs[385].dynamicFriction=0.6f;  EDefs[385].staticFriction=0.6f;  EDefs[385].bounciness=0.0f;  EDefs[385].frictionCombine=PHYS_COMBINE_AVG;  EDefs[385].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[386].path,"item_ammo_magcart",18); EDefs[386].modelIndex=2;  EDefs[386].collider=COLTYPE_CVX;  EDefs[386].colliderMeshIndex=674;  EDefs[386].mass=0.35f; EDefs[386].angularDrag=0.05f;  EDefs[386].gravity=1.0f;  EDefs[386].kinematic=false;  EDefs[386].dynamicFriction=0.6f;  EDefs[386].staticFriction=0.6f;  EDefs[386].bounciness=0.0f;  EDefs[386].frictionCombine=PHYS_COMBINE_AVG;  EDefs[386].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[387].path,"weapon_grenadeemp_live",23); EDefs[387].modelIndex=168;  EDefs[387].mass=1.0f;  EDefs[387].angularDrag=0.05f;  EDefs[387].gravity=1.0f;  EDefs[387].kinematic=false;  EDefs[387].dynamicFriction=0.6f;  EDefs[387].staticFriction=0.6f;  EDefs[387].bounciness=0.0f;  EDefs[387].frictionCombine=PHYS_COMBINE_AVG;  EDefs[387].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[388].path,"item_access_card_std",21); EDefs[388].modelIndex=0;  EDefs[388].texIndex=79;  EDefs[388].glowIndex=867;  EDefs[388].collider=COLTYPE_CVX;  EDefs[388].colliderMeshIndex=672;  EDefs[388].mass=0.2f; EDefs[388].angularDrag=0.05f;  EDefs[388].kinematic=false;  EDefs[388].dynamicFriction=0.6f;  EDefs[388].staticFriction=0.6f;  EDefs[388].bounciness=0.0f;  EDefs[388].frictionCombine=PHYS_COMBINE_AVG;  EDefs[388].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[389].path,"weapon_grenadeearth_live",25); EDefs[389].modelIndex=181;  EDefs[389].mass=1.0f;  EDefs[389].angularDrag=0.05f;  EDefs[389].gravity=1.0f;  EDefs[389].kinematic=false;  EDefs[389].dynamicFriction=0.6f;  EDefs[389].staticFriction=0.6f; EDefs[389].frictionCombine=PHYS_COMBINE_AVG;  EDefs[389].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[390].path,"item_access_card_group1",24); EDefs[390].modelIndex=0;  EDefs[390].texIndex=7;  EDefs[390].glowIndex=159;  EDefs[390].collider=COLTYPE_CVX;  EDefs[390].colliderMeshIndex=672;  EDefs[390].mass=0.2f; EDefs[390].angularDrag=0.05f; EDefs[390].kinematic=false;  EDefs[390].dynamicFriction=0.6f;  EDefs[390].staticFriction=0.6f;  EDefs[390].bounciness=0.0f;  EDefs[390].frictionCombine=PHYS_COMBINE_AVG;  EDefs[390].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[391].path,"item_access_card_science",25); EDefs[391].modelIndex=0;  EDefs[391].texIndex=2;  EDefs[391].glowIndex=343;  EDefs[391].collider=COLTYPE_CVX;  EDefs[391].colliderMeshIndex=672;  EDefs[391].mass=0.2f; EDefs[391].angularDrag=0.05f; EDefs[391].kinematic=false;  EDefs[391].dynamicFriction=0.6f;  EDefs[391].staticFriction=0.6f;  EDefs[391].bounciness=0.0f;  EDefs[391].frictionCombine=PHYS_COMBINE_AVG;  EDefs[391].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[392].path,"item_access_card_eng",21); EDefs[392].modelIndex=0;  EDefs[392].texIndex=3;  EDefs[392].glowIndex=81;  EDefs[392].collider=COLTYPE_CVX;  EDefs[392].colliderMeshIndex=672;  EDefs[392].mass=0.2f; EDefs[392].angularDrag=0.05f; EDefs[392].kinematic=false;  EDefs[392].dynamicFriction=0.6f;  EDefs[392].staticFriction=0.6f;  EDefs[392].bounciness=0.0f;  EDefs[392].frictionCombine=PHYS_COMBINE_AVG;  EDefs[392].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[393].path,"item_access_card_groupB",24); EDefs[393].modelIndex=0;  EDefs[393].texIndex=7;  EDefs[393].glowIndex=159;  EDefs[393].collider=COLTYPE_CVX;  EDefs[393].colliderMeshIndex=672;  EDefs[393].mass=0.2f; EDefs[393].angularDrag=0.05f;  EDefs[393].kinematic=false;  EDefs[393].dynamicFriction=0.6f;  EDefs[393].staticFriction=0.6f;  EDefs[393].bounciness=0.0f;  EDefs[393].frictionCombine=PHYS_COMBINE_AVG;  EDefs[393].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[394].path,"item_access_card_security",26); EDefs[394].modelIndex=0;  EDefs[394].texIndex=10;  EDefs[394].glowIndex=344;  EDefs[394].collider=COLTYPE_CVX;  EDefs[394].colliderMeshIndex=672;  EDefs[394].mass=0.2f; EDefs[394].angularDrag=0.05f; EDefs[394].kinematic=false;  EDefs[394].dynamicFriction=0.6f;  EDefs[394].staticFriction=0.6f;  EDefs[394].bounciness=0.0f;  EDefs[394].frictionCombine=PHYS_COMBINE_AVG;  EDefs[394].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[395].path,"item_access_card_per5diego",27); EDefs[395].modelIndex=0;  EDefs[395].texIndex=8;  EDefs[395].glowIndex=341;  EDefs[395].collider=COLTYPE_CVX;  EDefs[395].colliderMeshIndex=672;  EDefs[395].mass=0.2f; EDefs[395].angularDrag=0.05f; EDefs[395].kinematic=false;  EDefs[395].dynamicFriction=0.6f;  EDefs[395].staticFriction=0.6f;  EDefs[395].bounciness=0.0f;  EDefs[395].frictionCombine=PHYS_COMBINE_AVG;  EDefs[395].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[396].path,"item_access_card_medi",22); EDefs[396].modelIndex=0;  EDefs[396].texIndex=1;  EDefs[396].glowIndex=161;  EDefs[396].collider=COLTYPE_CVX;  EDefs[396].colliderMeshIndex=672;  EDefs[396].mass=0.2f; EDefs[396].angularDrag=0.05f; EDefs[396].kinematic=false;  EDefs[396].dynamicFriction=0.6f;  EDefs[396].staticFriction=0.6f;  EDefs[396].bounciness=0.0f;  EDefs[396].frictionCombine=PHYS_COMBINE_AVG;  EDefs[396].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[397].path,"item_access_card_group3",24); EDefs[397].modelIndex=0;  EDefs[397].texIndex=7;  EDefs[397].glowIndex=159;  EDefs[397].collider=COLTYPE_CVX;  EDefs[397].colliderMeshIndex=672;  EDefs[397].mass=0.2f; EDefs[397].angularDrag=0.05f; EDefs[397].dynamicFriction=0.6f;  EDefs[397].staticFriction=0.6f; EDefs[397].frictionCombine=PHYS_COMBINE_AVG;  EDefs[397].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[398].path,"item_access_card_purple",24); EDefs[398].modelIndex=0;  EDefs[398].texIndex=5;  EDefs[398].glowIndex=342;  EDefs[398].collider=COLTYPE_CVX;  EDefs[398].colliderMeshIndex=672;  EDefs[398].mass=0.2f; EDefs[398].angularDrag=0.05f; EDefs[398].dynamicFriction=0.6f;  EDefs[398].staticFriction=0.6f; EDefs[398].frictionCombine=PHYS_COMBINE_AVG;  EDefs[398].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[399].path,"item_head_male",15);   EDefs[399].modelIndex=194; EDefs[399].collider=COLTYPE_CVX; EDefs[399].colliderMeshIndex=687; EDefs[399].mass=1.29f; EDefs[399].angularDrag=0.05f; EDefs[399].dynamicFriction=0.6f; EDefs[399].staticFriction=0.6f; EDefs[399].frictionCombine=PHYS_COMBINE_AVG;  EDefs[399].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[400].path,"item_head_female",17); EDefs[400].modelIndex=193; EDefs[400].collider=COLTYPE_CVX; EDefs[400].colliderMeshIndex=686; EDefs[400].mass=1.30f; EDefs[400].angularDrag=0.05f; EDefs[400].dynamicFriction=0.6f; EDefs[400].staticFriction=0.6f; EDefs[400].frictionCombine=PHYS_COMBINE_AVG;  EDefs[400].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[401].path,"item_severedhead",17); EDefs[401].modelIndex=590; EDefs[401].mass=1.28f; EDefs[401].angularDrag=0.05f;  EDefs[401].gravity=1.0f; EDefs[401].dynamicFriction=0.6f;  EDefs[401].staticFriction=0.6f;  EDefs[401].frictionCombine=PHYS_COMBINE_AVG;  EDefs[401].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[402].path,"weapon_grenademine_live",24);  EDefs[402].modelIndex=184; EDefs[402].mass=1.0f; EDefs[402].angularDrag=0.05f; EDefs[402].gravity=1.0f; EDefs[402].dynamicFriction=0.6f;  EDefs[402].staticFriction=0.6f; EDefs[402].frictionCombine=PHYS_COMBINE_AVG; EDefs[402].bounceCombine=PHYS_COMBINE_AVG; 
    ...
    /*415 unused*/
    /*416 unused*/
    /*417 item_access_card_perdarcy*/  EDefs[417].modelIndex=0; EDefs[417].texIndex=8; EDefs[417].glowIndex=341; EDefs[417].collider=COLTYPE_CVX; EDefs[417].colliderMeshIndex=672; EDefs[417].mass=0.2f; EDefs[417].angularDrag=0.05f; EDefs[417].kinematic=false; EDefs[417].dynamicFriction=0.6f; EDefs[417].staticFriction=0.6f; EDefs[417].frictionCombine=PHYS_COMBINE_AVG; EDefs[417].bounceCombine=PHYS_COMBINE_AVG;

    // NPC Definitions
    for (int i=419;i<=447;++i) { EDefs[i].bounceCombine=PHYS_COMBINE_MAX; EDefs[i].collider=COLTYPE_CAP; EDefs[i].colliderSize.z=COLLIDER_CAPSULE_DIRECTION_Y_F; EDefs[i].frictionCombine=PHYS_COMBINE_MUL; EDefs[i].staticFriction=1.0f; EDefs[i].dynamicFriction=0.15f; EDefs[i].kinematic=true; EDefs[i].mass=1.0f; EDefs[i].angularDrag=2.2f; }
    ...
    for (int i=448;i<=457;++i) { EDefs[i].collider=COLTYPE_SPH; EDefs[i].colliderSize=(Vector3){1.5f,1.5f,1.5f}; }
    ...
    MemCpyFromBtoAForNBytes(EDefs[458].path,"prop_phys_barrel_chemical",26); EDefs[458].modelIndex=12;  EDefs[458].texIndex=30;  EDefs[458].mass=1.5f; EDefs[458].angularDrag=0.05f;  EDefs[458].gravity=1.0f;  EDefs[458].kinematic=false;  EDefs[458].dynamicFriction=0.6f;  EDefs[458].staticFriction=0.6f;  EDefs[458].bounciness=0.0f;  EDefs[458].frictionCombine=PHYS_COMBINE_AVG;  EDefs[458].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[459].path,"prop_phys_barrel_radiation",27); EDefs[459].modelIndex=12;  EDefs[459].texIndex=31;  EDefs[459].mass=1.5f;  EDefs[459].angularDrag=0.05f;  EDefs[459].gravity=1.0f;  EDefs[459].kinematic=false;  EDefs[459].dynamicFriction=0.6f;  EDefs[459].staticFriction=0.6f;  EDefs[459].bounciness=0.0f;  EDefs[459].frictionCombine=PHYS_COMBINE_AVG;  EDefs[459].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[460].path,"prop_phys_barrel_toxic",23); EDefs[460].modelIndex=12;  EDefs[460].texIndex=33;  EDefs[460].mass=1.5f; EDefs[460].angularDrag=0.05f;  EDefs[460].gravity=1.0f;  EDefs[460].kinematic=false;  EDefs[460].dynamicFriction=0.6f;  EDefs[460].staticFriction=0.6f;  EDefs[460].bounciness=0.0f;  EDefs[460].frictionCombine=PHYS_COMBINE_AVG;  EDefs[460].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[461].path,"prop_phys_cart",15); EDefs[461].modelIndex=40;  EDefs[461].texIndex=416;  EDefs[461].mass=2.5f; EDefs[461].angularDrag=0.05f;  EDefs[461].gravity=1.0f;  EDefs[461].kinematic=false;  EDefs[461].dynamicFriction=0.6f;  EDefs[461].staticFriction=0.6f;  EDefs[461].bounciness=0.0f;  EDefs[461].frictionCombine=PHYS_COMBINE_AVG;  EDefs[461].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[462].path,"prop_phys_pot",14); EDefs[462].modelIndex=494;  EDefs[462].mass=0.3f; EDefs[462].angularDrag=0.05f;  EDefs[462].gravity=1.0f;  EDefs[462].kinematic=false;  EDefs[462].dynamicFriction=0.6f;  EDefs[462].staticFriction=0.6f;  EDefs[462].bounciness=0.0f;  EDefs[462].frictionCombine=PHYS_COMBINE_AVG;  EDefs[462].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[463].path,"prop_phys_toolcart",19); EDefs[463].modelIndex=624;  EDefs[463].texIndex=865;  EDefs[463].normIndex=864;  EDefs[463].specIndex=866;  EDefs[463].mass=20.0f; EDefs[463].angularDrag=0.2f;  EDefs[463].gravity=1.0f;  EDefs[463].kinematic=false;  EDefs[463].dynamicFriction=0.6f;  EDefs[463].staticFriction=0.6f;  EDefs[463].bounciness=0.0f;  EDefs[463].frictionCombine=PHYS_COMBINE_AVG;  EDefs[463].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[464].path,"se_briefcase",13); EDefs[464].modelIndex=34;  EDefs[464].texIndex=66;  EDefs[464].glowIndex=65; 
    MemCpyFromBtoAForNBytes(EDefs[465].path,"se_corpse_blueshirt",20); EDefs[465].texIndex=126;  EDefs[465].specIndex=127;  EDefs[465].modelIndex=51; 
    MemCpyFromBtoAForNBytes(EDefs[466].path,"se_corpse_brownshirt",21); EDefs[466].texIndex=128;  EDefs[466].specIndex=129;  EDefs[466].modelIndex=52; 
    MemCpyFromBtoAForNBytes(EDefs[467].path,"se_corpse_eaten",16); EDefs[467].texIndex=130;  EDefs[467].specIndex=131;  EDefs[467].modelIndex=53; 
    MemCpyFromBtoAForNBytes(EDefs[468].path,"se_corpse_labcoat",18); EDefs[468].texIndex=132;  EDefs[468].specIndex=133;  EDefs[468].modelIndex=55; 
    MemCpyFromBtoAForNBytes(EDefs[469].path,"se_corpse_security",19); EDefs[469].texIndex=136;  EDefs[469].specIndex=137;  EDefs[469].modelIndex=56; 
    MemCpyFromBtoAForNBytes(EDefs[470].path,"se_corpse_tan",14); EDefs[470].texIndex=138;  EDefs[470].modelIndex=57; 
    MemCpyFromBtoAForNBytes(EDefs[471].path,"se_corpse_torso",16); EDefs[471].texIndex=126;  EDefs[471].specIndex=127;  EDefs[471].modelIndex=58; 
    MemCpyFromBtoAForNBytes(EDefs[472].path,"se_crate1",10); EDefs[472].texIndex=145;  EDefs[472].modelIndex=60;  EDefs[472].collider=COLTYPE_BOX;  EDefs[472].colliderCenter=(Vector3){0.0f,0.0f,0.3420931f};  EDefs[472].colliderSize=(Vector3){0.684186f,0.6841861f,0.6841861f};  EDefs[472].colliderMeshIndex=U16_MAX;  EDefs[472].mass=0.75f; EDefs[472].angularDrag=0.05f;  EDefs[472].gravity=1.0f;  EDefs[472].kinematic=false;  EDefs[472].dynamicFriction=0.6f;  EDefs[472].staticFriction=0.6f;  EDefs[472].bounciness=0.0f;  EDefs[472].frictionCombine=PHYS_COMBINE_AVG;  EDefs[472].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[473].path,"se_crate2",10); EDefs[473].texIndex=143;  EDefs[473].modelIndex=60;  EDefs[473].collider=COLTYPE_BOX;  EDefs[473].colliderCenter=(Vector3){0.0f,0.0f,0.3420931f};  EDefs[473].colliderSize=(Vector3){0.684186f,0.6841861f,0.6841861f};  EDefs[473].colliderMeshIndex=U16_MAX;  EDefs[473].mass=0.75f; EDefs[473].angularDrag=0.05f;  EDefs[473].gravity=1.0f;  EDefs[473].kinematic=false;  EDefs[473].dynamicFriction=0.6f;  EDefs[473].staticFriction=0.6f;  EDefs[473].bounciness=0.0f;  EDefs[473].frictionCombine=PHYS_COMBINE_AVG;  EDefs[473].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[474].path,"se_crate3",10); EDefs[474].texIndex=144;  EDefs[474].modelIndex=60;  EDefs[474].collider=COLTYPE_BOX;  EDefs[474].colliderCenter=(Vector3){0.0f,0.0f,0.3420931f};  EDefs[474].colliderSize=(Vector3){0.684186f,0.6841861f,0.6841861f};  EDefs[474].colliderMeshIndex=U16_MAX;  EDefs[474].mass=0.75f; EDefs[474].angularDrag=0.05f;  EDefs[474].gravity=1.0f;  EDefs[474].kinematic=false;  EDefs[474].dynamicFriction=0.6f;  EDefs[474].staticFriction=0.6f;  EDefs[474].bounciness=0.0f;  EDefs[474].frictionCombine=PHYS_COMBINE_AVG;  EDefs[474].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[475].path,"se_crate4",10); EDefs[475].texIndex=146;  EDefs[475].modelIndex=60;  EDefs[475].collider=COLTYPE_BOX;  EDefs[475].colliderCenter=(Vector3){0.0f,0.0f,0.3420931f};  EDefs[475].colliderSize=(Vector3){0.684186f,0.6841861f,0.6841861f};  EDefs[475].colliderMeshIndex=U16_MAX;  EDefs[475].mass=2.25f; EDefs[475].angularDrag=0.05f;  EDefs[475].gravity=1.0f;  EDefs[475].kinematic=false;  EDefs[475].dynamicFriction=0.6f;  EDefs[475].staticFriction=0.6f;  EDefs[475].bounciness=0.0f;  EDefs[475].frictionCombine=PHYS_COMBINE_AVG;  EDefs[475].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[476].path,"se_crate5",10); EDefs[476].modelIndex=60;  EDefs[476].collider=COLTYPE_BOX;  EDefs[476].colliderCenter=(Vector3){0.0f,0.0f,0.3420931f};  EDefs[476].colliderSize=(Vector3){0.684186f,0.6841861f,0.6841861f};  EDefs[476].colliderMeshIndex=U16_MAX;  EDefs[476].mass=2.25f; EDefs[476].angularDrag=0.05f;  EDefs[476].gravity=1.0f;  EDefs[476].kinematic=false;  EDefs[476].dynamicFriction=0.6f;  EDefs[476].staticFriction=0.6f;  EDefs[476].bounciness=0.0f;  EDefs[476].frictionCombine=PHYS_COMBINE_AVG;  EDefs[476].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[477].path,"sec_camera",11); EDefs[477].modelIndex=589;  EDefs[477].texIndex=73;  EDefs[477].glowIndex=72; 
    MemCpyFromBtoAForNBytes(EDefs[478].path,"sec_cpunode",12); EDefs[478].modelIndex=587;  EDefs[478].texIndex=242;  EDefs[478].glowIndex=248; 
    MemCpyFromBtoAForNBytes(EDefs[479].path,"sec_cpunode_small",18); EDefs[479].modelIndex=588;  EDefs[479].texIndex=107; 
    MemCpyFromBtoAForNBytes(EDefs[480].path,"weapon_cyber_mine",18); EDefs[480].modelIndex=71;  EDefs[480].texIndex=1224; 
    MemCpyFromBtoAForNBytes(EDefs[481].path,"proj_enemshot2",15); EDefs[481].modelIndex=MODEL_IDX_MAX;  EDefs[481].mass=0.3f; EDefs[481].angularDrag=0.05f;  EDefs[481].gravity=0.0f;  EDefs[481].kinematic=false;  EDefs[481].dynamicFriction=0.6f;  EDefs[481].staticFriction=0.6f;  EDefs[481].bounciness=0.0f;  EDefs[481].frictionCombine=PHYS_COMBINE_AVG;  EDefs[481].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[482].path,"proj_magpulse_shot",19); EDefs[482].modelIndex=MODEL_IDX_MAX;  EDefs[482].texIndex=807;  EDefs[482].mass=0.3f; EDefs[482].angularDrag=0.05f;  EDefs[482].gravity=0.0f;  EDefs[482].kinematic=false;  EDefs[482].dynamicFriction=0.6f;  EDefs[482].staticFriction=0.6f;  EDefs[482].bounciness=0.0f;  EDefs[482].frictionCombine=PHYS_COMBINE_AVG;  EDefs[482].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[483].path,"proj_stungun_shot",18); EDefs[483].modelIndex=MODEL_IDX_MAX;  EDefs[483].texIndex=835;  EDefs[483].mass=0.3f; EDefs[483].angularDrag=0.05f;  EDefs[483].gravity=0.0f;  EDefs[483].kinematic=false;  EDefs[483].dynamicFriction=0.6f;  EDefs[483].staticFriction=0.6f;  EDefs[483].bounciness=0.0f;  EDefs[483].frictionCombine=PHYS_COMBINE_AVG;  EDefs[483].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[484].path,"proj_rail_shot",15); EDefs[484].modelIndex=652;  EDefs[484].mass=0.3f; EDefs[484].angularDrag=0.05f;  EDefs[484].gravity=0.0f;  EDefs[484].kinematic=false;  EDefs[484].dynamicFriction=0.6f;  EDefs[484].staticFriction=0.6f;  EDefs[484].bounciness=0.0f;  EDefs[484].frictionCombine=PHYS_COMBINE_AVG;  EDefs[484].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[485].path,"proj_plasmarifle_shot",22); EDefs[485].modelIndex=651;  EDefs[485].mass=0.3f;  EDefs[485].angularDrag=0.05f;  EDefs[485].gravity=0.0f;  EDefs[485].kinematic=false;  EDefs[485].dynamicFriction=0.1f;  EDefs[485].staticFriction=0.2f;  EDefs[485].bounciness=0.9f;  EDefs[485].frictionCombine=PHYS_COMBINE_MUL;  EDefs[485].bounceCombine=PHYS_COMBINE_MAX; 
    MemCpyFromBtoAForNBytes(EDefs[486].path,"proj_enemshot6",15); EDefs[486].modelIndex=MODEL_IDX_MAX;  EDefs[486].mass=0.3f; EDefs[486].angularDrag=0.05f;  EDefs[486].gravity=0.0f;  EDefs[486].kinematic=false;  EDefs[486].dynamicFriction=0.6f;  EDefs[486].staticFriction=0.6f; EDefs[486].frictionCombine=PHYS_COMBINE_AVG;  EDefs[486].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[487].path,"proj_enemshot5",15); EDefs[487].modelIndex=MODEL_IDX_MAX;  EDefs[487].mass=0.2f; EDefs[487].angularDrag=0.05f;  EDefs[487].gravity=0.0f;  EDefs[487].kinematic=false;  EDefs[487].dynamicFriction=0.6f;  EDefs[487].staticFriction=0.6f; EDefs[487].frictionCombine=PHYS_COMBINE_AVG;  EDefs[487].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[488].path,"proj_enemshot4",15); EDefs[488].modelIndex=MODEL_IDX_MAX;  EDefs[488].mass=0.3f; EDefs[488].angularDrag=0.05f;  EDefs[488].gravity=0.0f;  EDefs[488].kinematic=false;  EDefs[488].dynamicFriction=0.6f;  EDefs[488].staticFriction=0.6f; EDefs[488].frictionCombine=PHYS_COMBINE_AVG;  EDefs[488].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[489].path,"proj_throwingstar",18); EDefs[489].modelIndex=307;  EDefs[489].mass=0.3f;  EDefs[489].angularDrag=0.05f;  EDefs[489].gravity=0.0f; EDefs[489].dynamicFriction=0.6f;  EDefs[489].staticFriction=0.6f; EDefs[489].frictionCombine=PHYS_COMBINE_AVG;  EDefs[489].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[490].path,"proj_magpulsenpc_shot",22); EDefs[490].modelIndex=645;  EDefs[490].mass=0.3f; EDefs[490].angularDrag=0.05f;  EDefs[490].gravity=0.0f; EDefs[490].dynamicFriction=0.6f;  EDefs[490].staticFriction=0.6f; EDefs[490].frictionCombine=PHYS_COMBINE_AVG;  EDefs[490].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[491].path,"proj_railnpc_shot",18); EDefs[491].modelIndex=MODEL_IDX_MAX;  EDefs[491].mass=0.3f;  EDefs[491].angularDrag=0.05f;  EDefs[491].gravity=0.0f; EDefs[491].dynamicFriction=0.6f;  EDefs[491].staticFriction=0.6f; EDefs[491].frictionCombine=PHYS_COMBINE_AVG;  EDefs[491].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[492].path,"proj_cyberplayer_shot",22); EDefs[492].modelIndex=72;  EDefs[492].mass=0.3f; EDefs[492].angularDrag=0.05f;  EDefs[492].gravity=0.0f;
    MemCpyFromBtoAForNBytes(EDefs[493].path,"proj_cyberdog_shot",19); EDefs[493].modelIndex=63;  EDefs[493].mass=0.3f;  EDefs[493].angularDrag=0.05f;  EDefs[493].gravity=0.0f; EDefs[493].dynamicFriction=0.6f;  EDefs[493].staticFriction=0.6f; EDefs[493].frictionCombine=PHYS_COMBINE_AVG;  EDefs[493].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[494].path,"proj_cyberreaver_shot",22); EDefs[494].modelIndex=64;  EDefs[494].mass=0.3f;  EDefs[494].angularDrag=0.05f;  EDefs[494].gravity=0.0f; EDefs[494].dynamicFriction=0.6f;  EDefs[494].staticFriction=0.6f; EDefs[494].frictionCombine=PHYS_COMBINE_AVG;  EDefs[494].bounceCombine=PHYS_COMBINE_AVG; 
    MemCpyFromBtoAForNBytes(EDefs[495].path,"proj_cyberice_shot",19); EDefs[495].modelIndex=68;  EDefs[495].mass=0.3f; EDefs[495].angularDrag=0.05f;  EDefs[495].gravity=0.0f; EDefs[495].dynamicFriction=0.6f;  EDefs[495].staticFriction=0.6f; EDefs[495].frictionCombine=PHYS_COMBINE_AVG;  EDefs[495].bounceCombine=PHYS_COMBINE_AVG; 
    for (int i=496;i<515;++i) EDefs[i].SFXIndex = 75;
    MemCpyFromBtoAForNBytes(EDefs[496].path,"doorA",6); EDefs[496].modelIndex=719; EDefs[496].texIndex=185; EDefs[496].numclips=4;    EDefs[496].animationNum=1;                           EDefs[496].collider=COLTYPE_MSH;
    MemCpyFromBtoAForNBytes(EDefs[497].path,"doorB",6); EDefs[497].modelIndex=0;  EDefs[497].texIndex=189;  EDefs[497].glowIndex=188; EDefs[497].numclips=4;    EDefs[497].animationNum=0; EDefs[497].collider=COLTYPE_MSH;
    MemCpyFromBtoAForNBytes(EDefs[498].path,"doorC",6); EDefs[498].modelIndex=0;  EDefs[498].texIndex=184;  EDefs[498].numclips=4;    EDefs[498].animationNum=5;                           EDefs[498].collider=COLTYPE_MSH;
    MemCpyFromBtoAForNBytes(EDefs[499].path,"doorD",6); EDefs[499].modelIndex=0;  EDefs[499].numclips=4;  EDefs[499].animationNum=4;  EDefs[499].texIndex=196;  EDefs[499].glowIndex=197;  EDefs[499].collider=COLTYPE_MSH;
    MemCpyFromBtoAForNBytes(EDefs[500].path,"doorE",6); EDefs[500].modelIndex=0;  EDefs[500].numclips=4;  EDefs[500].animationNum=9;  EDefs[500].texIndex=208;  EDefs[500].glowIndex=207;  EDefs[500].collider=COLTYPE_MSH;
    MemCpyFromBtoAForNBytes(EDefs[501].path,"doorF",6); EDefs[501].modelIndex=0;  EDefs[501].numclips=4;  EDefs[501].animationNum=10; EDefs[501].texIndex=187;                             EDefs[501].collider=COLTYPE_MSH;
    MemCpyFromBtoAForNBytes(EDefs[502].path,"doorG",6); EDefs[502].modelIndex=0;  EDefs[502].numclips=4;  EDefs[502].animationNum=11; EDefs[502].texIndex=193;  EDefs[502].glowIndex=194;  EDefs[502].collider=COLTYPE_MSH;
    MemCpyFromBtoAForNBytes(EDefs[503].path,"doorH",6); EDefs[503].modelIndex=0;  EDefs[503].numclips=4;  EDefs[503].animationNum=12; EDefs[503].texIndex=190;                             EDefs[503].collider=COLTYPE_MSH;
    MemCpyFromBtoAForNBytes(EDefs[504].path,"doorI",6); EDefs[504].modelIndex=0;  EDefs[504].numclips=4;  EDefs[504].animationNum=13; EDefs[504].texIndex=200;  EDefs[504].glowIndex=199;  EDefs[504].collider=COLTYPE_MSH;
    MemCpyFromBtoAForNBytes(EDefs[505].path,"doorJ",6); EDefs[505].modelIndex=0;  EDefs[505].numclips=4;  EDefs[505].animationNum=6;  EDefs[505].texIndex=215;                             EDefs[505].collider=COLTYPE_MSH;
    MemCpyFromBtoAForNBytes(EDefs[506].path,"doorK",6); EDefs[506].modelIndex=0;  EDefs[506].numclips=4;  EDefs[506].animationNum=7;  EDefs[506].texIndex=214;                             EDefs[506].collider=COLTYPE_MSH;
    MemCpyFromBtoAForNBytes(EDefs[507].path,"doorL",6); EDefs[507].modelIndex=0;  EDefs[507].numclips=4;  EDefs[507].animationNum=8;  EDefs[507].texIndex=191;                             EDefs[507].collider=COLTYPE_MSH;
    MemCpyFromBtoAForNBytes(EDefs[508].path,"door_elevator1",15); EDefs[508].modelIndex=0;  EDefs[508].numclips=4;  EDefs[508].animationNum=14;  EDefs[508].texIndex=202;                  EDefs[508].collider=COLTYPE_MSH;
    MemCpyFromBtoAForNBytes(EDefs[509].path,"door_elevator2",15); EDefs[509].modelIndex=0;  EDefs[509].numclips=4;  EDefs[509].animationNum=15;  EDefs[509].texIndex=203;                  EDefs[509].collider=COLTYPE_MSH;
    MemCpyFromBtoAForNBytes(EDefs[510].path,"door_elevator3",15); EDefs[510].modelIndex=0;  EDefs[510].numclips=4;  EDefs[510].animationNum=16;  EDefs[510].texIndex=206;  EDefs[510].glowIndex=205; EDefs[510].collider=COLTYPE_MSH;
    MemCpyFromBtoAForNBytes(EDefs[511].path,"door_elevator4",15); EDefs[511].modelIndex=0;  EDefs[511].numclips=4;  EDefs[511].animationNum=17;  EDefs[511].texIndex=203;                  EDefs[511].collider=COLTYPE_MSH;
    MemCpyFromBtoAForNBytes(EDefs[512].path,"door_secret1",13); EDefs[512].modelIndex=0;  EDefs[512].numclips=4;  EDefs[512].animationNum=19;  EDefs[512].texIndex=210;                    EDefs[512].collider=COLTYPE_MSH;
    MemCpyFromBtoAForNBytes(EDefs[513].path,"door_secret2",13); EDefs[513].modelIndex=0;  EDefs[513].numclips=4;  EDefs[513].animationNum=18;  EDefs[513].texIndex=209;                    EDefs[513].collider=COLTYPE_MSH;
    MemCpyFromBtoAForNBytes(EDefs[514].path,"door_secret3",13); EDefs[514].modelIndex=94;  EDefs[514].numclips=4;  EDefs[514].animationNum=20;  EDefs[514].texIndex=211;                   EDefs[514].collider=COLTYPE_MSH;
    MemCpyFromBtoAForNBytes(EDefs[515].path,"func_forcebridge",17); EDefs[515].modelIndex=78;  EDefs[515].texIndex=38; EDefs[476].collider=COLTYPE_BOX;
    MemCpyFromBtoAForNBytes(EDefs[516].path,"prop_lift2",11); EDefs[516].modelIndex=215;  EDefs[516].texIndex=155;  EDefs[516].glowIndex=154;  EDefs[516].collider=COLTYPE_BOX;  EDefs[516].colliderCenter=(Vector3){0.0f,0.0f,0.0f};  EDefs[516].colliderSize=(Vector3){1.0f,1.0f,1.0f};  EDefs[516].colliderMeshIndex=U16_MAX; 
    MemCpyFromBtoAForNBytes(EDefs[517].path,"func_wall",10);  EDefs[517].mass=10.0f;  EDefs[517].angularDrag=0.05f;  EDefs[517].gravity=0.0f;  EDefs[517].kinematic=true;  EDefs[517].dynamicFriction=0.6f;  EDefs[517].staticFriction=0.6f;  EDefs[517].bounciness=0.0f;  EDefs[517].frictionCombine=PHYS_COMBINE_AVG;  EDefs[517].bounceCombine=PHYS_COMBINE_AVG;
    MemCpyFromBtoAForNBytes(EDefs[518].path,"BulletHoleLarge",16);
    MemCpyFromBtoAForNBytes(EDefs[519].path,"BulletHoleScorchLarge",22);
    MemCpyFromBtoAForNBytes(EDefs[520].path,"BulletHoleScorchSmall",22);
    MemCpyFromBtoAForNBytes(EDefs[521].path,"BulletHoleSmall",16);
    MemCpyFromBtoAForNBytes(EDefs[522].path,"BulletHoleTiny",15);
    MemCpyFromBtoAForNBytes(EDefs[523].path,"BulletHoleTinySpread",21);
    MemCpyFromBtoAForNBytes(EDefs[524].path,"func_door_cyber",16); EDefs[524].modelIndex=178;  EDefs[524].texIndex=1224;  EDefs[524].collider=COLTYPE_BOX;  EDefs[524].colliderCenter=(Vector3){0.0f,1.31f,0.0f};  EDefs[524].colliderSize=(Vector3){2.56f,0.06f,2.56f};  EDefs[524].colliderMeshIndex=U16_MAX; 
    MemCpyFromBtoAForNBytes(EDefs[525].path,"prop_console01",15); EDefs[525].texIndex=100;  EDefs[525].modelIndex=49; 
    MemCpyFromBtoAForNBytes(EDefs[526].path,"prop_console02",15); EDefs[526].texIndex=100;  EDefs[526].modelIndex=50; 
    MemCpyFromBtoAForNBytes(EDefs[527].path,"prop_grate1_1",14); EDefs[527].modelIndex=186;  EDefs[527].texIndex=359; 
    MemCpyFromBtoAForNBytes(EDefs[528].path,"prop_grate1_2",14); EDefs[528].modelIndex=187;  EDefs[528].texIndex=360; 
    MemCpyFromBtoAForNBytes(EDefs[529].path,"prop_grate1_3",14); EDefs[529].modelIndex=188;  EDefs[529].texIndex=361; 
    MemCpyFromBtoAForNBytes(EDefs[530].path,"se_cabinet",11); EDefs[530].modelIndex=39;  EDefs[530].texIndex=70; 
    MemCpyFromBtoAForNBytes(EDefs[531].path,"se_thermos",11); EDefs[531].texIndex=863;  EDefs[531].modelIndex=623; 
    MemCpyFromBtoAForNBytes(EDefs[532].path,"prop_beaker_holder",19); EDefs[532].modelIndex=15;  EDefs[532].texIndex=36; 
    MemCpyFromBtoAForNBytes(EDefs[533].path,"prop_bed",9); EDefs[533].modelIndex=16;  EDefs[533].texIndex=246; 
    MemCpyFromBtoAForNBytes(EDefs[534].path,"prop_bed_hospital",18); EDefs[534].modelIndex=608;  EDefs[534].texIndex=759; 
    MemCpyFromBtoAForNBytes(EDefs[535].path,"prop_bed_neurosurgery",22); EDefs[535].texIndex=18;  EDefs[535].normIndex=29;  EDefs[535].specIndex=1238;  EDefs[535].modelIndex=17; 
    MemCpyFromBtoAForNBytes(EDefs[536].path,"prop_bonepile1",15); EDefs[536].modelIndex=19;  EDefs[536].texIndex=815; 
    MemCpyFromBtoAForNBytes(EDefs[537].path,"prop_bridgewall1",17); EDefs[537].modelIndex=33; 
    MemCpyFromBtoAForNBytes(EDefs[538].path,"prop_broken_clock",18); EDefs[538].modelIndex=38;  EDefs[538].texIndex=1117;  EDefs[538].altTexIndex=1118;  EDefs[538].glowIndex=1115;  EDefs[538].altGlowIndex=1116; 
    MemCpyFromBtoAForNBytes(EDefs[539].path,"prop_brokengun",15); EDefs[539].modelIndex=639;  EDefs[539].texIndex=878; 
    MemCpyFromBtoAForNBytes(EDefs[540].path,"prop_chair01",13); EDefs[540].modelIndex=41;  EDefs[540].texIndex=195; 
    MemCpyFromBtoAForNBytes(EDefs[541].path,"prop_chair02",13); EDefs[541].modelIndex=42;  EDefs[541].texIndex=195; 
    MemCpyFromBtoAForNBytes(EDefs[542].path,"prop_chair03",13); EDefs[542].modelIndex=43;  EDefs[542].texIndex=195; 
    MemCpyFromBtoAForNBytes(EDefs[543].path,"prop_chair04",13); EDefs[543].modelIndex=41;  EDefs[543].texIndex=195; 
    MemCpyFromBtoAForNBytes(EDefs[544].path,"prop_chair05",13); EDefs[544].modelIndex=42;  EDefs[544].texIndex=195; 
    MemCpyFromBtoAForNBytes(EDefs[545].path,"prop_chandelier",16); EDefs[545].modelIndex=496;  EDefs[545].texIndex=644; 
    MemCpyFromBtoAForNBytes(EDefs[546].path,"prop_charge_station",20); EDefs[546].modelIndex=44;  EDefs[546].texIndex=77;  EDefs[546].glowIndex=76; 
    MemCpyFromBtoAForNBytes(EDefs[547].path,"prop_clothes",13); EDefs[547].modelIndex=47;  EDefs[547].texIndex=97; 
    MemCpyFromBtoAForNBytes(EDefs[548].path,"prop_computer",14); EDefs[548].modelIndex=48; 
    MemCpyFromBtoAForNBytes(EDefs[549].path,"prop_couch",11); EDefs[549].modelIndex=59; 
    MemCpyFromBtoAForNBytes(EDefs[550].path,"prop_couch2",12); EDefs[550].modelIndex=59; 
    MemCpyFromBtoAForNBytes(EDefs[551].path,"prop_cpuscreen",15); EDefs[551].modelIndex=178;  EDefs[551].texIndex=768; 
    MemCpyFromBtoAForNBytes(EDefs[552].path,"prop_cyber_datafrag",20); EDefs[552].modelIndex=78; 
    MemCpyFromBtoAForNBytes(EDefs[553].path,"prop_cyber_decoy",17); EDefs[553].modelIndex=78; 
    MemCpyFromBtoAForNBytes(EDefs[554].path,"prop_cyber_exit",16); EDefs[554].modelIndex=78; 
    MemCpyFromBtoAForNBytes(EDefs[555].path,"prop_cyber_switch",18); EDefs[555].modelIndex=0; 
    MemCpyFromBtoAForNBytes(EDefs[556].path,"prop_cyberport",15); EDefs[556].modelIndex=62;  EDefs[556].texIndex=117;  EDefs[556].glowIndex=116; 
    MemCpyFromBtoAForNBytes(EDefs[557].path,"prop_desk01",12); EDefs[557].modelIndex=74;  EDefs[557].texIndex=125; 
    MemCpyFromBtoAForNBytes(EDefs[558].path,"prop_desk02",12); EDefs[558].modelIndex=75;  EDefs[558].texIndex=124; 
    MemCpyFromBtoAForNBytes(EDefs[559].path,"prop_dexmissile",16); EDefs[559].modelIndex=76;  EDefs[559].texIndex=164;  EDefs[559].glowIndex=162; 
    MemCpyFromBtoAForNBytes(EDefs[560].path,"prop_foliage_fernpoison",24); EDefs[560].modelIndex=160;  EDefs[560].texIndex=331; 
    MemCpyFromBtoAForNBytes(EDefs[561].path,"prop_foliage_bush",18); EDefs[561].modelIndex=495;  EDefs[561].texIndex=643;  EDefs[561].glowIndex=642; 
    MemCpyFromBtoAForNBytes(EDefs[562].path,"prop_foliage_fern",18); EDefs[562].modelIndex=160;  EDefs[562].texIndex=333;  EDefs[562].glowIndex=330; 
    MemCpyFromBtoAForNBytes(EDefs[563].path,"prop_foliage_fernblueflower",28); EDefs[563].modelIndex=159;  EDefs[563].texIndex=333;  EDefs[563].glowIndex=330; 
    MemCpyFromBtoAForNBytes(EDefs[564].path,"prop_foliage_pinetreem",23); EDefs[564].modelIndex=489;  EDefs[564].texIndex=594; 
    MemCpyFromBtoAForNBytes(EDefs[565].path,"prop_foliage_poisonbush1",25); EDefs[565].modelIndex=493; EDefs[565].texIndex=638;
    MemCpyFromBtoAForNBytes(EDefs[566].path,"prop_gear_large",16); EDefs[566].modelIndex=166; EDefs[566].texIndex=335;
    MemCpyFromBtoAForNBytes(EDefs[567].path,"prop_gear_small",16); EDefs[567].modelIndex=167; EDefs[567].texIndex=336;
    MemCpyFromBtoAForNBytes(EDefs[568].path,"prop_grass1",12); EDefs[568].texIndex=329;
    MemCpyFromBtoAForNBytes(EDefs[569].path,"prop_grass2",12); EDefs[569].texIndex=329;
    MemCpyFromBtoAForNBytes(EDefs[570].path,"prop_grass3",12); EDefs[570].texIndex=329;
    MemCpyFromBtoAForNBytes(EDefs[571].path,"prop_grass4",12); EDefs[571].texIndex=329;
    MemCpyFromBtoAForNBytes(EDefs[572].path,"prop_grass5",12); EDefs[572].texIndex=329;
    MemCpyFromBtoAForNBytes(EDefs[573].path,"prop_grate4",12); EDefs[573].modelIndex=161;  EDefs[573].texIndex=329; 
    MemCpyFromBtoAForNBytes(EDefs[574].path,"prop_healingbed",16); EDefs[574].modelIndex=195;  EDefs[574].texIndex=1139; 
    MemCpyFromBtoAForNBytes(EDefs[575].path,"prop_lamp",10); EDefs[575].modelIndex=212;  EDefs[575].texIndex=423; 
    MemCpyFromBtoAForNBytes(EDefs[576].path,"prop_light_emergsignal",23); EDefs[576].modelIndex=216;  EDefs[576].texIndex=426;  EDefs[576].altTexIndex=424;  EDefs[576].glowIndex=0;  EDefs[576].altGlowIndex=424; 
    MemCpyFromBtoAForNBytes(EDefs[577].path,"prop_microscope",16); EDefs[577].modelIndex=298;  EDefs[577].texIndex=645;  EDefs[577].specIndex=1241; 
    MemCpyFromBtoAForNBytes(EDefs[578].path,"prop_pipe",10); EDefs[578].modelIndex=490;  EDefs[578].texIndex=595; 
    MemCpyFromBtoAForNBytes(EDefs[579].path,"prop_puddle",12); EDefs[579].modelIndex=157;  EDefs[579].texIndex=648; 
    MemCpyFromBtoAForNBytes(EDefs[580].path,"prop_puddle_grease",19); EDefs[580].modelIndex=157;  EDefs[580].texIndex=650; 
    MemCpyFromBtoAForNBytes(EDefs[581].path,"prop_puddle_oil",16); EDefs[581].modelIndex=157;  EDefs[581].texIndex=652; 
    MemCpyFromBtoAForNBytes(EDefs[582].path,"prop_shelves",13); EDefs[582].modelIndex=591;  EDefs[582].texIndex=94; 
    MemCpyFromBtoAForNBytes(EDefs[583].path,"prop_skeleton",14); EDefs[583].modelIndex=592;  EDefs[583].texIndex=815; 
    MemCpyFromBtoAForNBytes(EDefs[584].path,"prop_sleeping_cables",21); EDefs[584].modelIndex=595;  EDefs[584].texIndex=71; 
    MemCpyFromBtoAForNBytes(EDefs[585].path,"prop_sparkingwire",18); EDefs[585].modelIndex=0;  EDefs[585].numclips=1;  EDefs[585].animationNum=46;  EDefs[585].texIndex=71; 
    MemCpyFromBtoAForNBytes(EDefs[586].path,"prop_table",11); EDefs[586].modelIndex=619;  EDefs[586].texIndex=92; 
    MemCpyFromBtoAForNBytes(EDefs[587].path,"prop_tv_on_a_post",18); EDefs[587].modelIndex=625;  EDefs[587].texIndex=1228; 
    MemCpyFromBtoAForNBytes(EDefs[588].path,"prop_vendingmachines1",22); EDefs[588].modelIndex=627;  EDefs[588].texIndex=870; 
    MemCpyFromBtoAForNBytes(EDefs[589].path,"prop_vendingmachines2",22); EDefs[589].modelIndex=614;  EDefs[589].texIndex=871; 
    MemCpyFromBtoAForNBytes(EDefs[590].path,"prop_weapon_rack",17); EDefs[590].modelIndex=641;  EDefs[590].texIndex=113; 
    MemCpyFromBtoAForNBytes(EDefs[591].path,"prop_xray",10); EDefs[591].modelIndex=660;  EDefs[591].texIndex=153; 
    MemCpyFromBtoAForNBytes(EDefs[592].path,"text_decal",11); EDefs[592].modelIndex=77; 
    MemCpyFromBtoAForNBytes(EDefs[593].path,"text_decalStopDSS1",19); EDefs[593].modelIndex=77; 
    MemCpyFromBtoAForNBytes(EDefs[594].path,"trigger_counter",16);
    MemCpyFromBtoAForNBytes(EDefs[595].path,"trigger_cyberpush",18);
    MemCpyFromBtoAForNBytes(EDefs[596].path,"trigger_gravitylift",20);
    MemCpyFromBtoAForNBytes(EDefs[597].path,"trigger_ladder",15);
    MemCpyFromBtoAForNBytes(EDefs[598].path,"trigger_multiple",17);
    MemCpyFromBtoAForNBytes(EDefs[599].path,"trigger_music",14);
    MemCpyFromBtoAForNBytes(EDefs[600].path,"trigger_once",13);
    MemCpyFromBtoAForNBytes(EDefs[601].path,"trigger_radiation",18);
    MemCpyFromBtoAForNBytes(EDefs[602].path,"us_isotopepanel",16); EDefs[602].modelIndex=0;  EDefs[602].texIndex=616;  EDefs[602].numclips=5;  EDefs[602].animationNum=44; 
    MemCpyFromBtoAForNBytes(EDefs[603].path,"us_paperlog",12); EDefs[603].modelIndex=486;  EDefs[603].texIndex=580; 
    MemCpyFromBtoAForNBytes(EDefs[604].path,"us_puz_elevatorkeypad",22); EDefs[604].modelIndex=615;  EDefs[604].texIndex=247; 
    MemCpyFromBtoAForNBytes(EDefs[605].path,"us_puz_elevatorkeypad2",23); EDefs[605].modelIndex=618;  EDefs[605].texIndex=250; 
    MemCpyFromBtoAForNBytes(EDefs[606].path,"us_puz_elevatorkeypad3",23); EDefs[606].modelIndex=615;  EDefs[606].texIndex=247; 
    MemCpyFromBtoAForNBytes(EDefs[607].path,"us_puz_elevatorkeypad4",23); EDefs[607].modelIndex=210;  EDefs[607].texIndex=249; 
    MemCpyFromBtoAForNBytes(EDefs[608].path,"us_puz_keypad",14); EDefs[608].modelIndex=211;  EDefs[608].texIndex=414; 
    MemCpyFromBtoAForNBytes(EDefs[609].path,"us_puz_panel_blue_grid",23); EDefs[609].modelIndex=0;  EDefs[609].texIndex=604;  EDefs[609].numclips=3;  EDefs[609].animationNum=43; 
    MemCpyFromBtoAForNBytes(EDefs[610].path,"us_puz_panel_brown_grid",24); EDefs[610].modelIndex=0;  EDefs[610].texIndex=604;  EDefs[610].numclips=3;  EDefs[610].animationNum=43; 
    MemCpyFromBtoAForNBytes(EDefs[611].path,"us_puz_panel_gray_grid",23); EDefs[611].modelIndex=0;  EDefs[611].texIndex=634;  EDefs[611].numclips=3;  EDefs[611].animationNum=43; 
    MemCpyFromBtoAForNBytes(EDefs[612].path,"us_puz_panel_red_grid",22); EDefs[612].modelIndex=0;  EDefs[612].texIndex=625;  EDefs[612].numclips=3;  EDefs[612].animationNum=43; 
    MemCpyFromBtoAForNBytes(EDefs[613].path,"us_puz_panel_teal_grid",23); EDefs[613].modelIndex=0;  EDefs[613].texIndex=601;  EDefs[613].numclips=3;  EDefs[613].animationNum=43; 
    MemCpyFromBtoAForNBytes(EDefs[614].path,"us_relaypanel",14); EDefs[614].modelIndex=0;  EDefs[614].texIndex=617;  EDefs[614].numclips=4;  EDefs[614].animationNum=45; 
    MemCpyFromBtoAForNBytes(EDefs[615].path,"us_retinalscanner",18); EDefs[615].modelIndex=79;  EDefs[615].texIndex=46; 
    MemCpyFromBtoAForNBytes(EDefs[616].path,"prop_vending1_1",16); EDefs[616].modelIndex=627;  EDefs[616].texIndex=870; 
    MemCpyFromBtoAForNBytes(EDefs[617].path,"prop_vending1_2",16); EDefs[617].modelIndex=628;  EDefs[617].texIndex=870; 
    MemCpyFromBtoAForNBytes(EDefs[618].path,"prop_vending1_3",16); EDefs[618].modelIndex=629;  EDefs[618].texIndex=870; 
    MemCpyFromBtoAForNBytes(EDefs[619].path,"prop_vending2_1",16); EDefs[619].modelIndex=614;  EDefs[619].texIndex=871; 
    MemCpyFromBtoAForNBytes(EDefs[620].path,"prop_vending2_2",16); EDefs[620].modelIndex=621;  EDefs[620].texIndex=871; 
    MemCpyFromBtoAForNBytes(EDefs[621].path,"ambient_airhiss",16); EDefs[621].volume=0.05f;
    MemCpyFromBtoAForNBytes(EDefs[622].path,"ambient_clicker",16); EDefs[622].volume=0.20f;
    MemCpyFromBtoAForNBytes(EDefs[623].path,"ambient_compressor",19); EDefs[623].volume=0.4f;
    MemCpyFromBtoAForNBytes(EDefs[624].path,"ambient_dishwasher",19); EDefs[624].volume=0.2f;
    MemCpyFromBtoAForNBytes(EDefs[625].path,"ambient_drip_amb",17); EDefs[625].volume=0.5f;
    MemCpyFromBtoAForNBytes(EDefs[626].path,"ambient_fan",12); EDefs[626].volume=0.3f;
    MemCpyFromBtoAForNBytes(EDefs[627].path,"ambient_generator_gas",22); EDefs[627].volume=0.3f;
    MemCpyFromBtoAForNBytes(EDefs[628].path,"ambient_gurgle",15); EDefs[628].volume=0.3f;
    MemCpyFromBtoAForNBytes(EDefs[629].path,"ambient_icemaker",17); EDefs[629].volume=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[630].path,"ambient_intake",15); EDefs[630].volume=0.2f;
    MemCpyFromBtoAForNBytes(EDefs[631].path,"ambient_lathe",14); EDefs[631].volume=0.4f;
    MemCpyFromBtoAForNBytes(EDefs[632].path,"ambient_lev3loop1",18); EDefs[632].volume=0.1f;
    MemCpyFromBtoAForNBytes(EDefs[633].path,"ambient_lev3loop2",18); EDefs[633].volume=0.1f;
    MemCpyFromBtoAForNBytes(EDefs[634].path,"ambient_lev3loop3",18); EDefs[634].volume=0.1f;
    MemCpyFromBtoAForNBytes(EDefs[635].path,"ambient_lev3loop4",18); EDefs[635].volume=0.1f;
    MemCpyFromBtoAForNBytes(EDefs[636].path,"ambient_liquid_bubble",22); EDefs[636].volume=1.0f;
    MemCpyFromBtoAForNBytes(EDefs[637].path,"ambient_liquid_lava2",21); EDefs[637].volume=0.4f;
    MemCpyFromBtoAForNBytes(EDefs[638].path,"ambient_looping",16); EDefs[638].volume=0.4f;
    MemCpyFromBtoAForNBytes(EDefs[639].path,"ambient_machgear_loop",22); EDefs[639].volume=0.4f;
    MemCpyFromBtoAForNBytes(EDefs[640].path,"ambient_machine_ambience",25); EDefs[640].volume=0.8f;
    MemCpyFromBtoAForNBytes(EDefs[641].path,"ambient_machine_go",19); EDefs[641].volume=0.6f;
    MemCpyFromBtoAForNBytes(EDefs[642].path,"ambient_machine_humamb7",24); EDefs[642].volume=1.0f;
    MemCpyFromBtoAForNBytes(EDefs[643].path,"ambient_machine_humlonoise",27); EDefs[643].volume=0.4f;
    MemCpyFromBtoAForNBytes(EDefs[644].path,"ambient_machine_loop1",22); EDefs[644].volume=0.4f;
    MemCpyFromBtoAForNBytes(EDefs[645].path,"ambient_machine_loop2",22); EDefs[645].volume=0.4f;
    MemCpyFromBtoAForNBytes(EDefs[646].path,"ambient_machinea1",18); EDefs[646].volume=0.4f;
    MemCpyFromBtoAForNBytes(EDefs[647].path,"ambient_machinevat_loop",24); EDefs[647].volume=0.8f;
    MemCpyFromBtoAForNBytes(EDefs[648].path,"ambient_mist",13); EDefs[648].volume=0.02f;
    MemCpyFromBtoAForNBytes(EDefs[649].path,"ambient_pipewater_loop",23); EDefs[649].volume=0.65f;
    MemCpyFromBtoAForNBytes(EDefs[650].path,"ambient_powerloom",18); EDefs[650].volume=0.3f;
    MemCpyFromBtoAForNBytes(EDefs[651].path,"ambient_pump",13); EDefs[651].volume=0.2f;
    MemCpyFromBtoAForNBytes(EDefs[652].path,"ambient_pump2",14); EDefs[652].volume=0.05f;
    MemCpyFromBtoAForNBytes(EDefs[653].path,"ambient_rain",13); EDefs[653].volume=0.55f;
    MemCpyFromBtoAForNBytes(EDefs[654].path,"ambient_steam_loop",19); EDefs[654].volume=0.1f;
    MemCpyFromBtoAForNBytes(EDefs[655].path,"ambient_washing_machine",24); EDefs[655].volume=0.5f;
    MemCpyFromBtoAForNBytes(EDefs[656].path,"decal_blood_die",16); EDefs[656].modelIndex=77;  EDefs[656].texIndex=237;  EDefs[656].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[657].path,"decal_blood_resist",19); EDefs[657].modelIndex=77;  EDefs[657].texIndex=240;  EDefs[657].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[658].path,"decal_blood_stayaway",21); EDefs[658].modelIndex=77;  EDefs[658].texIndex=235;  EDefs[658].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[659].path,"decal_blood_words2",19); EDefs[659].modelIndex=77;  EDefs[659].texIndex=236;  EDefs[659].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[660].path,"decal_bloodfonta",17); EDefs[660].modelIndex=178;  EDefs[660].texIndex=118;  EDefs[660].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[661].path,"decal_bloodfonte",17); EDefs[661].modelIndex=178;  EDefs[661].texIndex=121;  EDefs[661].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[662].path,"decal_bloodfontg",17); EDefs[662].modelIndex=178;  EDefs[662].texIndex=122;  EDefs[662].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[663].path,"decal_bloodfonth",17); EDefs[663].modelIndex=178;  EDefs[663].texIndex=89;  EDefs[663].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[664].path,"decal_bloodfontr",17); EDefs[664].modelIndex=178;  EDefs[664].texIndex=139;  EDefs[664].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[665].path,"decal_bloodfonty",17); EDefs[665].modelIndex=178;  EDefs[665].texIndex=140;  EDefs[665].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[666].path,"decal_bloodsplat2",18); EDefs[666].modelIndex=157;  EDefs[666].texIndex=130;  EDefs[666].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[667].path,"decal_logo_antenna",19); EDefs[667].modelIndex=77;  EDefs[667].texIndex=182;  EDefs[667].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[668].path,"decal_logo_armory",18); EDefs[668].modelIndex=77;  EDefs[668].texIndex=178;  EDefs[668].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[669].path,"decal_logo_biohazard",21); EDefs[669].modelIndex=77;  EDefs[669].texIndex=180;  EDefs[669].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[670].path,"decal_logo_bridge",18); EDefs[670].modelIndex=77;  EDefs[670].texIndex=181;  EDefs[670].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[671].path,"decal_logo_cyborg",18); EDefs[671].modelIndex=77;  EDefs[671].texIndex=176;  EDefs[671].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[672].path,"decal_logo_gears",17); EDefs[672].modelIndex=77;  EDefs[672].texIndex=174;  EDefs[672].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[673].path,"decal_logo_medical",19); EDefs[673].modelIndex=77;  EDefs[673].texIndex=165;  EDefs[673].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[674].path,"decal_logo_radhazard",21); EDefs[674].modelIndex=77;  EDefs[674].texIndex=177;  EDefs[674].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[675].path,"decal_logo_research",20); EDefs[675].modelIndex=77;  EDefs[675].texIndex=175;  EDefs[675].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[676].path,"decal_logo_security",20); EDefs[676].modelIndex=77;  EDefs[676].texIndex=167;  EDefs[676].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[677].path,"decal_painting1",16); EDefs[677].modelIndex=77;  EDefs[677].texIndex=218;  EDefs[677].glowIndex=216;  EDefs[677].normIndex=217;  EDefs[677].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[678].path,"decal_painting2",16); EDefs[678].modelIndex=77;  EDefs[678].texIndex=220;  EDefs[678].glowIndex=219;  EDefs[678].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[679].path,"decal_painting3",16); EDefs[679].modelIndex=77;  EDefs[679].texIndex=222;  EDefs[679].glowIndex=221;  EDefs[679].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[680].path,"decal_posterbetterfuture",25); EDefs[680].modelIndex=77;  EDefs[680].texIndex=226;  EDefs[680].normIndex=225;  EDefs[680].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[681].path,"decal_postergenetics",21); EDefs[681].modelIndex=77;  EDefs[681].texIndex=224;  EDefs[681].normIndex=223;  EDefs[681].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[682].path,"decal_scorch1",14); EDefs[682].modelIndex=77;  EDefs[682].texIndex=227;  EDefs[682].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[683].path,"decal_scorch2",14); EDefs[683].modelIndex=77;  EDefs[683].texIndex=228;  EDefs[683].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[684].path,"decal_scorch3",14); EDefs[684].modelIndex=77;  EDefs[684].texIndex=229;  EDefs[684].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[685].path,"decal_scorch4",14); EDefs[685].modelIndex=77;  EDefs[685].texIndex=230;  EDefs[685].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[686].path,"decal_scorchtiny",17); EDefs[686].modelIndex=77;  EDefs[686].texIndex=232;  EDefs[686].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[687].path,"decal_blood_splat",18); EDefs[687].modelIndex=77;  EDefs[687].texIndex=234;  EDefs[687].shadows=false; 
    MemCpyFromBtoAForNBytes(EDefs[688].path,"func_switch1",13); EDefs[688].modelIndex=609;  EDefs[688].texIndex=837;  EDefs[688].collider=COLTYPE_BOX;  EDefs[688].colliderCenter=(Vector3){0.0f,0.0f,0.0f};  EDefs[688].colliderSize=(Vector3){0.32f,0.04f,0.32f}; EDefs[688].colliderMeshIndex=U16_MAX; 
    MemCpyFromBtoAForNBytes(EDefs[689].path,"func_switch2",13); EDefs[689].modelIndex=610;  EDefs[689].texIndex=839;  EDefs[689].mainSwitchMaterial=839;  EDefs[689].altTexIndex=841;  EDefs[689].glowIndex=0;  EDefs[689].altGlowIndex=840;  EDefs[689].changeTexOnActive=true; EDefs[689].blinkTexOnActive=true;  EDefs[689].collider=COLTYPE_BOX;  EDefs[689].colliderCenter=(Vector3){-0.0243553f,0.0f,0.000004883f};  EDefs[689].colliderSize=(Vector3){0.0476318f,0.64f,0.64f};  EDefs[689].colliderMeshIndex=U16_MAX; 
    MemCpyFromBtoAForNBytes(EDefs[690].path,"func_switch3",13); EDefs[690].modelIndex=611;  EDefs[690].texIndex=842;  EDefs[690].altTexIndex=844;  EDefs[690].glowIndex=0;  EDefs[690].altGlowIndex=843;  EDefs[690].changeTexOnActive=true;  EDefs[690].collider=COLTYPE_BOX;  EDefs[690].colliderCenter=(Vector3){-0.02285008f,0.000053061f,-0.000056993f};  EDefs[690].colliderSize=(Vector3){0.02f,0.32f,0.32f};  EDefs[690].colliderMeshIndex=U16_MAX; 
    MemCpyFromBtoAForNBytes(EDefs[691].path,"func_switch4",13); EDefs[691].modelIndex=612;  EDefs[691].texIndex=846;  EDefs[691].collider=COLTYPE_BOX;  EDefs[691].colliderCenter=(Vector3){0.06f,0.0f,0.0f};  EDefs[691].colliderSize=(Vector3){0.2f,0.64f,0.64f};  EDefs[691].colliderMeshIndex=U16_MAX; 
    MemCpyFromBtoAForNBytes(EDefs[692].path,"func_switch5",13); EDefs[692].modelIndex=614;  EDefs[692].texIndex=848;  EDefs[692].collider=COLTYPE_BOX;  EDefs[692].colliderCenter=(Vector3){0.0f,0.0f,0.0f};  EDefs[692].colliderSize=(Vector3){0.64f,0.64f,0.08f};  EDefs[692].colliderMeshIndex=U16_MAX; 
    MemCpyFromBtoAForNBytes(EDefs[693].path,"func_switch5broken",19); EDefs[693].modelIndex=613;  EDefs[693].texIndex=847;  EDefs[693].collider=COLTYPE_BOX;  EDefs[693].colliderCenter=(Vector3){0.0f,0.0f,0.0f};  EDefs[693].colliderSize=(Vector3){0.64f,0.64f,0.08f};  EDefs[693].colliderMeshIndex=U16_MAX; 
    MemCpyFromBtoAForNBytes(EDefs[694].path,"func_switch7",13); EDefs[694].modelIndex=612;  EDefs[694].texIndex=854;  EDefs[694].collider=COLTYPE_BOX;  EDefs[694].colliderCenter=(Vector3){1.523325f,0.0f,0.0f};  EDefs[694].colliderSize=(Vector3){0.2008026f,0.64f,0.64f};  EDefs[694].colliderMeshIndex=U16_MAX; 
    MemCpyFromBtoAForNBytes(EDefs[695].path,"func_switch8",13); EDefs[695].modelIndex=616;  EDefs[695].texIndex=856;  EDefs[695].altTexIndex=858;  EDefs[695].glowIndex=855;  EDefs[695].altGlowIndex=857;  EDefs[695].changeTexOnActive=true;  EDefs[695].collider=COLTYPE_BOX;  EDefs[695].colliderCenter=(Vector3){-0.04f,0.0f,0.0001220703f};  EDefs[695].colliderSize=(Vector3){0.08f,0.64f,0.64f};  EDefs[695].colliderMeshIndex=U16_MAX; 
    MemCpyFromBtoAForNBytes(EDefs[696].path,"func_switchbroken1",19); EDefs[696].modelIndex=617;  EDefs[696].texIndex=618; 
    MemCpyFromBtoAForNBytes(EDefs[697].path,"clip_npc",9); EDefs[697].collider=COLTYPE_BOX;  EDefs[697].colliderCenter=(Vector3){1.005016f,0.0f,0.0f};  EDefs[697].colliderSize=(Vector3){2.010033f,16.0f,16.0f};  EDefs[697].colliderMeshIndex=U16_MAX;
    MemCpyFromBtoAForNBytes(EDefs[698].path,"clip_objects",13); EDefs[698].collider=COLTYPE_BOX;  EDefs[698].colliderCenter=(Vector3){0.0f,0.0f,0.0f};  EDefs[698].colliderSize=(Vector3){2.56f,2.56f,2.56f};  EDefs[698].colliderMeshIndex=U16_MAX;
    MemCpyFromBtoAForNBytes(EDefs[699].path,"logic_relay",12);
    MemCpyFromBtoAForNBytes(EDefs[700].path,"logic_branch",13);
    MemCpyFromBtoAForNBytes(EDefs[701].path,"logic_timer",12);
    MemCpyFromBtoAForNBytes(EDefs[702].path,"logic_spawner",14);
    MemCpyFromBtoAForNBytes(EDefs[703].path,"info_teleport_destination",26);
    MemCpyFromBtoAForNBytes(EDefs[704].path,"prop_debris_panel",18);
    MemCpyFromBtoAForNBytes(EDefs[705].path,"info_cyborgconversion",22);
    MemCpyFromBtoAForNBytes(EDefs[706].path,"info_elev_destination",22);
    MemCpyFromBtoAForNBytes(EDefs[707].path,"info_email",11);
    MemCpyFromBtoAForNBytes(EDefs[708].path,"info_gameend",13);
    MemCpyFromBtoAForNBytes(EDefs[709].path,"info_message",13);
    MemCpyFromBtoAForNBytes(EDefs[710].path,"info_mission",13);
    MemCpyFromBtoAForNBytes(EDefs[711].path,"info_note",10);
    MemCpyFromBtoAForNBytes(EDefs[712].path,"info_playsound",15);
    MemCpyFromBtoAForNBytes(EDefs[713].path,"info_ressurection_point",24);
    MemCpyFromBtoAForNBytes(EDefs[714].path,"info_screenshake",17);
    MemCpyFromBtoAForNBytes(EDefs[715].path,"info_spawnpoint",16);
    MemCpyFromBtoAForNBytes(EDefs[716].path,"fx_reverbzone",14);
    MemCpyFromBtoAForNBytes(EDefs[717].path,"ef_cyber_ice",13); EDefs[717].collider=COLTYPE_SPH;  EDefs[717].colliderCenter=(Vector3){0.0f,0.004354001f,-0.014725f};  EDefs[717].colliderSize=(Vector3){1.0f,0.0f,0.0f};  EDefs[717].colliderMeshIndex=U16_MAX; 
    MemCpyFromBtoAForNBytes(EDefs[718].path,"ef_fragexplosion",17);
    MemCpyFromBtoAForNBytes(EDefs[719].path,"ef_line_sparqbeam",18);
    MemCpyFromBtoAForNBytes(EDefs[720].path,"ef_mist",8);
...
//     for (;i<endInstance;++i) Eng_Global->instances[i] = Eng_Global->instances[i + 1]; // Shift the entire list down, overwriting the entity we're deleting at starting i
    for (;i<endInstance;++i) MemCpyFromBtoAForNBytes(&Eng_Global->instances[i],&Eng_Global->instances[i+1],sizeof(Entity));
