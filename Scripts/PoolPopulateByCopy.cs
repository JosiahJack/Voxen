...
public class PoolPopulateByCopy : MonoBehaviour {
    ...
    public void CreateCopy() {
		GameObject copy = Instantiate(transform.GetChild(0).gameObject,instances[i].position,Const.a.quaternionIdentity) as GameObject; // create a copy of a pool object
		if (copy != null) {
