...
#ifndef DRWAV_ASSERT
#define DRWAV_ASSERT(expression)           (void)(expression)
#endif
#ifndef DRWAV_MALLOC
...
#define DRWAV_COPY_MEMORY(dst, src, sz)    CopyMemoryFromBtoAForNBytes((dst), (src), (sz))
#endif
#ifndef DRWAV_ZERO_MEMORY
#define DRWAV_ZERO_MEMORY(p, sz)           SetMemoryToValueForNBytes((p), 0, (sz))
#endif
