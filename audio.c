...
const char* sounds[SOUNDS_COUNT] = {
    ...
    "cyborgs/cyborgwarrior_die"/*51*/, "cyborgs/diego_blubber"/*52*/, "cyborgs/ediego_dontkeepmewaiting"/*53*/, "cyborgs/ediego_faceme"/*54*/, "cyborgs/ediego_facexecutioner"/*55*/,"cyborgs/ediego_finishexecution"/*56*/, "cyborgs/ediego_wewillmeetagain"/*57*/, "cyborgs/yourlevelsareterrible"/*58*/, "cyborgs/yourweaponsareshoddybadweapons"/*59*/, "destroy/attack1_explode"/*60*/,
    "destroy/camera_destroy"/*61*/, "destroy/crate_break"/*62*/, "destroy/explode_minor"/*63*/,"destroy/explosion1"/*64*/, "destroy/explosion2"/*65*/, "destroy/explosion3"/*66*/, "destroy/hit2"/*67*/, "destroy/hit3"/*68*/, "destroy/screen_destroy"/*69*/, "doors/door_platform"/*70*/, "doors/doorbulkhead_open"/*71*/,"doors/doorbulkhead_open2"/*72*/,
    "doors/doorcompartment_open"/*73*/, "doors/doormech_open"/*74*/, "doors/doorpnuematic_open"/*75*/, "doors/doorwall_move"/*76*/, "doors/doorwall_stop"/*77*/, "hud/activate"/*78*/, "hud/batteryuse"/*79*/,"hud/changeweapon"/*80*/, "hud/cyber"/*81*/, "hud/deactivate"/*82*/, "hud/emailalert"/*83*/, "hud/energy_gone"/*84*/, "hud/envirosuit_on"/*85*/, "hud/frob_hardware"/*86*/,
    "hud/frob_item"/*87*/,"hud/jumpjets_off"/*88*/, "hud/patchuse"/*89*/, "hud/radiation"/*90*/, "hud/searchsound"/*91*/, "hud/select"/*92*/, "hud/sensaround"/*93*/, "hud/shield_absorb"/*94*/, "hud/shield_off"/*95*/,"hud/shield_on"/*96*/, "hud/tab"/*97*/, "hud/targetacquire"/*98*/, "hud/vmailalert"/*99*/, "misc/chargingstation"/*100*/, "misc/energy_hum"/*101*/,
    "misc/forcebridge"/*102*/, "misc/healstation"/*103*/,"misc/klaxon_station_alarm"/*104*/, "misc/machine_on"/*105*/, "misc/teleport"/*106*/, "misc/wing-o"/*107*/, "mutants/avianmut_attack"/*108*/, "mutants/avianmut_die"/*109*/, "mutants/avianmut_die2"/*110*/, "mutants/avianmut_sightsound"/*111*/,"mutants/footstep1"/*112*/, "mutants/footstep2"/*113*/, "mutants/footstep3"/*114*/,
    "mutants/footstep4"/*115*/, "mutants/footstep5"/*116*/, "mutants/gortiger_die"/*117*/, "mutants/gortiger_idle1"/*118*/, "mutants/gortiger_sightsound"/*119*/,"mutants/invisiblemut_die"/*120*/, "mutants/invisiblemut_idle1"/*121*/, "mutants/mutant_attack"/*122*/, "mutants/mutant_die"/*123*/, "mutants/plantmut_die2"/*124*/, "mutants/plantmut_throw"/*125*/,
    "mutants/plantmutstep1"/*126*/, "mutants/plantmutstep2"/*127*/,"mutants/plantmutstep3"/*128*/, "mutants/steplarge1"/*129*/, "mutants/steplarge2"/*130*/, "mutants/steplarge3"/*131*/, "mutants/steplarge4"/*132*/, "mutants/steplarge5"/*133*/, "mutants/virusmut_die"/*134*/, "player/jump"/*135*/,"player/jumpland"/*136*/, "player/ladder"/*137*/, "player/painalarm"/*138*/, 
    "player/painalarmfast"/*139*/, "player/playerpain1"/*140*/, "robots/bot_destroy1"/*141*/, "robots/bot_destroy2"/*142*/, "robots/bot_destroy3"/*143*/,"robots/bot_destroy4"/*144*/, "robots/bot_destroybig"/*145*/, "robots/bot_pincherattack"/*146*/, "robots/bot_shoot1"/*147*/, "robots/bot_shoot2"/*148*/, "robots/bot_shoot3"/*149*/, "robots/bot_sight1"/*150*/,
    "robots/bot_sight2"/*151*/,"robots/bot_sight3"/*152*/, "robots/footfall"/*153*/, "robots/footstep1"/*154*/, "robots/footstep2"/*155*/, "robots/footstep3"/*156*/, "robots/footstephuge1"/*157*/, "robots/footstephuge2"/*158*/, "robots/footstephuge3"/*159*/,"robots/footstepsmall1"/*160*/, "robots/footstepsmall2"/*161*/, "robots/hopper_die"/*162*/, "robots/servo"/*163*/,
    "vox/vox_abortingprogram"/*164*/, "vox/vox_accesspanellocked"/*165*/, "vox/vox_accesspanelunlocked"/*166*/, "vox/vox_armoryaccessoverriden"/*167*/,"vox/vox_armoryaccessreinstituted"/*168*/, "vox/vox_baydoor3locked"/*169*/, "vox/vox_betagrovejettisoned"/*170*/, "vox/vox_betagrovelvatrunlocked"/*171*/, "vox/vox_biocontaminantdetected"/*172*/, "vox/vox_blastdoorlocked"/*173*/,
    "vox/vox_blastdoorunlocked"/*174*/, "vox/vox_bridgesepdone"/*175*/,"vox/vox_bridgesepsoon"/*176*/, "vox/vox_bridgesepstage1"/*177*/, "vox/vox_bridgesepstage2"/*178*/, "vox/vox_cameractivsecdoor"/*179*/, "vox/vox_chargeraccessgranted"/*180*/, "vox/vox_chargeroff"/*181*/, "vox/vox_corelocksdisengaged"/*182*/, "vox/vox_cybconvcancelled"/*183*/,"vox/vox_cybconvenabled"/*184*/,
    "vox/vox_demodsuccess"/*185*/, "vox/vox_destructcancelled"/*186*/, "vox/vox_destructnotenabled"/*187*/, "vox/vox_destructsecaccess"/*188*/, "vox/vox_doorclosedisabled"/*189*/, "vox/vox_ediegostorageclosetunlocked"/*190*/, "vox/vox_elevatordisabled"/*191*/,"vox/vox_emeraccesslocked"/*192*/, "vox/vox_entercode"/*193*/, "vox/vox_fallingairpressure"/*194*/,
    "vox/vox_flightbayarmoryunlocked"/*195*/, "vox/vox_forcedoor1opened"/*196*/, "vox/vox_forcedoor2opened"/*197*/, "vox/vox_forcedoor3opened"/*198*/, "vox/vox_gammajettisoned"/*199*/,"vox/vox_grovejettisoned"/*200*/, "vox/vox_grovejettisonstage1"/*201*/, "vox/vox_groveunlocked"/*202*/, "vox/vox_hallaccess"/*203*/, "vox/vox_hospitalsecdoorsopened"/*204*/,
    "vox/vox_jettisonalreadyenabled"/*205*/, "vox/vox_jettisonenabled"/*206*/, "vox/vox_jettisonfailure"/*207*/,"vox/vox_lifepodcancelled"/*208*/, "vox/vox_lifepodlaunchstart"/*209*/, "vox/vox_lifepodsdisabled"/*210*/, "vox/vox_maintdoorlocked"/*211*/, "vox/vox_needisotope"/*212*/, "vox/vox_nomasterjettisonenabled"/*213*/, "vox/vox_nosecaccess"/*214*/,
    "vox/vox_powerdivertedtor"/*215*/,"vox/vox_programinstalled"/*216*/, "vox/vox_radiationshielddeacticated"/*217*/, "vox/vox_radiationtreatdone"/*218*/, "vox/vox_reactorcountdown"/*219*/, "vox/vox_reactoroveloadstart"/*220*/, "vox/vox_reactoroverloadaccess"/*221*/, "vox/vox_reactoroverloadbypassed"/*222*/, "vox/vox_receptacleisolinearchipset"/*223*/,
    "vox/vox_relay428failure"/*224*/, "vox/vox_relay428faulty"/*225*/, "vox/vox_relayfixed"/*226*/, "vox/vox_replacedemodulator"/*227*/, "vox/vox_robotprodcancelled"/*228*/, "vox/vox_robotsactivated"/*229*/, "vox/vox_safetyinterlockdisabled"/*230*/, "vox/vox_safetyinterlockengaged"/*231*/,"vox/vox_safetyinterlocksenabled"/*232*/, "vox/vox_safetyoverridesonolaser"/*233*/,
    "vox/vox_secompoverrideneeded"/*234*/, "vox/vox_shieldgeneratorsready"/*235*/, "vox/vox_shieldson"/*236*/, "vox/vox_thelaserisdestroyed"/*237*/, "weapons/noammo"/*238*/, "weapons/wblaster"/*239*/,"weapons/wdartgun"/*240*/, "weapons/wdrill"/*241*/, "weapons/wearthshake"/*242*/, "weapons/wflechette"/*243*/, "weapons/wgrenade_arm"/*244*/, "weapons/wion"/*245*/,
    "weapons/wlaserrapier_hit"/*246*/, "weapons/wlaserrapier_swing"/*247*/,"weapons/wlocknload"/*248*/, "weapons/wmagnum"/*249*/, "weapons/wmagpulse"/*250*/, "weapons/wmarksman"/*251*/, "weapons/wpipe_dmg"/*252*/, "weapons/wpipe_hit"/*253*/, "weapons/wpipe_swing"/*254*/, "weapons/wpistol"/*255*/,"weapons/wpistolsilenced"/*256*/, "weapons/wplasma"/*257*/, "weapons/wpulser"/*258*/,
    "weapons/wrailgun"/*259*/, "weapons/wreload"/*260*/, "weapons/wricoshet"/*261*/, "weapons/wriotgun"/*262*/, "weapons/wskorpion"/*263*/,"weapons/wsparq"/*264*/, "weapons/wstungun"/*265*/, "weapons/wwoosh"/*266*/, ""/*267*/, "footsteps/Carpet/carpet_step1"/*268*/, "footsteps/Carpet/carpet_step2"/*269*/, "footsteps/Carpet/carpet_step3"/*270*/,
    "footsteps/Carpet/carpet_step4"/*271*/,"footsteps/Carpet/carpet_step5"/*272*/, "footsteps/Carpet/carpet_step6"/*273*/, "footsteps/Carpet/carpet_step7"/*274*/, "footsteps/Carpet/carpet_step8"/*275*/, "footsteps/Concrete/concrete_step1"/*276*/, "footsteps/Concrete/concrete_step2"/*277*/, "footsteps/Concrete/concrete_step3"/*278*/, "footsteps/Concrete/concrete_step4"/*279*/,
    ...
    "footsteps/Concrete Gritty/concrete_grit_step4"/*287*/,"footsteps/Concrete Gritty/concrete_grit_step5"/*288*/, "footsteps/Concrete Gritty/concrete_grit_step6"/*289*/, "footsteps/Concrete Gritty/concrete_grit_step7"/*290*/, "footsteps/Concrete Gritty/concrete_grit_step8"/*291*/, "footsteps/Earth/earth_step1"/*292*/, "footsteps/Earth/earth_step2"/*293*/,
    "footsteps/Earth/earth_step3"/*294*/, "footsteps/Earth/earth_step4"/*295*/,"footsteps/Earth/earth_step5"/*296*/, "footsteps/Earth/earth_step6"/*297*/, "footsteps/Earth/earth_step7"/*298*/, "footsteps/Earth/earth_step8"/*299*/, "footsteps/Earth/gravel_step1"/*300*/, "footsteps/Earth/gravel_step2"/*301*/, "footsteps/Earth/gravel_step3"/*302*/,
    "footsteps/Earth/gravel_step4"/*303*/,"footsteps/Earth/gravel_step5"/*304*/, "footsteps/Earth/gravel_step6"/*305*/, "footsteps/Earth/gravel_step7"/*306*/, "footsteps/Earth/gravel_step8"/*307*/, "footsteps/Earth/rock_step1"/*308*/, "footsteps/Earth/rock_step2"/*309*/, "footsteps/Earth/rock_step3"/*310*/, "footsteps/Earth/rock_step4"/*311*/,"footsteps/Earth/rock_step5"/*312*/,
    "footsteps/Earth/rock_step6"/*313*/, "footsteps/Earth/rock_step7"/*314*/, "footsteps/Earth/rock_step8"/*315*/, "footsteps/Glass/glasssolid_step1"/*316*/, "footsteps/Glass/glasssolid_step2"/*317*/, "footsteps/Glass/glasssolid_step3"/*318*/, "footsteps/Glass/glasssolid_step4"/*319*/,"footsteps/Glass/glasssolid_step5"/*320*/, "footsteps/Glass/glasssolid_step6"/*321*/,
    "footsteps/Glass/glasssolid_step7"/*322*/, "footsteps/Glass/glasssolid_step8"/*323*/, "footsteps/Marble/marble_step1"/*324*/, "footsteps/Marble/marble_step2"/*325*/, "footsteps/Marble/marble_step3"/*326*/, "footsteps/Marble/marble_step4"/*327*/,"footsteps/Marble/marble_step5"/*328*/, "footsteps/Marble/marble_step6"/*329*/, "footsteps/Marble/marble_step7"/*330*/,
    "footsteps/Marble/marble_step8"/*331*/, "footsteps/Metal/metal_step1"/*332*/, "footsteps/Metal/metal_step2"/*333*/, "footsteps/Metal/metal_step3"/*334*/, "footsteps/Metal/metal_step4"/*335*/,"footsteps/Metal/metal_step5"/*336*/, "footsteps/Metal/metal_step6"/*337*/, "footsteps/Metal/metal_step7"/*338*/, "footsteps/Metal/metal_step8"/*339*/,
    "footsteps/Metal/metalgrate_step1"/*340*/, "footsteps/Metal/metalgrate_step2"/*341*/, "footsteps/Metal/metalgrate_step3"/*342*/, "footsteps/Metal/metalgrate_step4"/*343*/,"footsteps/Metal/metalgrate_step5"/*344*/, "footsteps/Metal/metalgrate_step6"/*345*/, "footsteps/Metal/metalgrate_step7"/*346*/, "footsteps/Metal/metalgrate_step8"/*347*/,
    "footsteps/Metal/metalsolid_step1"/*348*/, "footsteps/Metal/metalsolid_step2"/*349*/, "footsteps/Metal/metalsolid_step3"/*350*/, "footsteps/Metal/metalsolid_step4"/*351*/,"footsteps/Metal/metalsolid_step5"/*352*/, "footsteps/Metal/metalsolid_step6"/*353*/, "footsteps/Metal/metalsolid_step7"/*354*/, "footsteps/Metal/metalsolid_step8"/*355*/,
    "footsteps/Metal/metalthin_step1"/*356*/, "footsteps/Metal/metalthin_step2"/*357*/, "footsteps/Metal/metalthin_step3"/*358*/, "footsteps/Metal/metalthin_step4"/*359*/,"footsteps/Metal/metalthin_step5"/*360*/, "footsteps/Metal/metalthin_step6"/*361*/, "footsteps/Metal/metalthin_step7"/*362*/, "footsteps/Metal/metalthin_step8"/*363*/, "footsteps/Panel/panel_step1"/*364*/,
    "footsteps/Panel/panel_step2"/*365*/, "footsteps/Panel/panel_step3"/*366*/, "footsteps/Panel/panel_step4"/*367*/,"footsteps/Panel/panel_step5"/*368*/, "footsteps/Panel/panel_step6"/*369*/, "footsteps/Panel/panel_step7"/*370*/, "footsteps/Panel/panel_step8"/*371*/, "footsteps/Plaster/plaster_step1"/*372*/, "footsteps/Plaster/plaster_step2"/*373*/,
    "footsteps/Plaster/plaster_step3"/*374*/, "footsteps/Plaster/plaster_step4"/*375*/,"footsteps/Plaster/plaster_step5"/*376*/, "footsteps/Plaster/plaster_step6"/*377*/, "footsteps/Plaster/plaster_step7"/*378*/, "footsteps/Plaster/plaster_step8"/*379*/, "footsteps/Plastic/plastic_step1"/*380*/, "footsteps/Plastic/plastic_step2"/*381*/, "footsteps/Plastic/plastic_step3"/*382*/,
    "footsteps/Plastic/plastic_step4"/*383*/,"footsteps/Plastic/plastic_step5"/*384*/, "footsteps/Plastic/plastic_step6"/*385*/, "footsteps/Plastic/plastic_step7"/*386*/, "footsteps/Plastic/plastic_step8"/*387*/, "footsteps/Plastic/plasticsolid_step1"/*388*/, "footsteps/Plastic/plasticsolid_step2"/*389*/, "footsteps/Plastic/plasticsolid_step3"/*390*/,
    "footsteps/Plastic/plasticsolid_step4"/*391*/,"footsteps/Plastic/plasticsolid_step5"/*392*/, "footsteps/Plastic/plasticsolid_step6"/*393*/, "footsteps/Plastic/plasticsolid_step7"/*394*/, "footsteps/Plastic/plasticsolid_step8"/*395*/, "footsteps/Rubber/rubber_step1"/*396*/, "footsteps/Rubber/rubber_step2"/*397*/, "footsteps/Rubber/rubber_step3"/*398*/,
    "footsteps/Rubber/rubber_step4"/*399*/,"footsteps/Rubber/rubber_step5"/*400*/, "footsteps/Rubber/rubber_step6"/*401*/, "footsteps/Rubber/rubber_step7"/*402*/, "footsteps/Rubber/rubber_step8"/*403*/, "footsteps/Sand/sand_step1"/*404*/, "footsteps/Sand/sand_step2"/*405*/, "footsteps/Sand/sand_step3"/*406*/, "footsteps/Sand/sand_step4"/*407*/,"footsteps/Sand/sand_step5"/*408*/,
    "footsteps/Sand/sand_step6"/*409*/, "footsteps/Sand/sand_step7"/*410*/, "footsteps/Sand/sand_step8"/*411*/, "footsteps/Squish/squish_step1"/*412*/, "footsteps/Squish/squish_step2"/*413*/, "footsteps/Squish/squish_step3"/*414*/, "footsteps/Squish/squish_step4"/*415*/,"footsteps/Squish/squish_step5"/*416*/, "footsteps/Squish/squish_step6"/*417*/,
    "footsteps/Squish/squish_step7"/*418*/, "footsteps/Squish/squish_step8"/*419*/, "footsteps/Squish/squish_step9"/*420*/, "footsteps/Squish/squish_step10"/*421*/, "footsteps/Squish/squish_step11"/*422*/, "footsteps/Squish/squish_step12"/*423*/,"footsteps/Squish/squish_step13"/*424*/, "footsteps/Squish/squish_step14"/*425*/, "footsteps/Squish/squish_step15"/*426*/,
    "footsteps/Squish/squish_step16"/*427*/, "footsteps/Vent/vent_step1"/*428*/, "footsteps/Vent/vent_step2"/*429*/, "footsteps/Vent/vent_step3"/*430*/, "footsteps/Vent/vent_step4"/*431*/,"footsteps/Vent/vent_step5"/*432*/, "footsteps/Vent/vent_step6"/*433*/, "footsteps/Vent/vent_step7"/*434*/, "footsteps/Vent/vent_step8"/*435*/, "footsteps/Vent/vent_step9"/*436*/,
    "footsteps/Vent/vent_step10"/*437*/, "footsteps/Water/water_foot_step1"/*438*/, "footsteps/Water/water_foot_step2"/*439*/,"footsteps/Water/water_foot_step3"/*440*/, "footsteps/Water/water_foot_step4"/*441*/, "footsteps/Water/water_foot_step5"/*442*/, "footsteps/Wood/wood_step1"/*443*/, "footsteps/Wood/wood_step2"/*444*/, "footsteps/Wood/wood_step3"/*445*/,
    "footsteps/Wood/wood_step4"/*446*/, "footsteps/Wood/wood_step5"/*447*/, "footsteps/Wood/wood_step6"/*448*/, "footsteps/Wood/wood_step7"/*449*/, "footsteps/Wood/wood_step8"/*450*/, "footsteps/Wood/woodcrate_step1"/*451*/, "footsteps/Wood/woodcrate_step2"/*452*/, "footsteps/Wood/woodcrate_step3"/*453*/, "footsteps/Wood/woodcrate_step4"/*454*/,
    "footsteps/Wood/woodcrate_step5"/*455*/,"footsteps/Wood/woodcrate_step6"/*456*/, "footsteps/Wood/woodcrate_step7"/*457*/, "footsteps/Wood/woodcrate_step8"/*458*/, "footsteps/Clothes/rustle01"/*459*/, "footsteps/Clothes/rustle02"/*460*/, "footsteps/Clothes/rustle03"/*461*/, "footsteps/Clothes/rustle01"/*462*/, "footsteps/Clothes/rustle05"/*463*/,
...
const char* audioLogs[LOGCNT] = {"logs/ghiran-2"/*0*/,"logs/steinberg-1"/*1*/,"logs/raines-1"/*2*/,"logs/sigmund-1"/*3*/,"logs/stevens-1"/*4*/,"shodan/shodan_youmychildren"/*5*/,""/*6*/,"logs/oconnel-1"/*7*/,"logs/honig-1"/*8*/,"logs/honig-2"/*9*/,"logs/stackhouse-1"/*10*/,"shodan/shodan_directivetocyborgf71"/*11*/,"logs/kirby-1"/*12*/,"logs/ozark-1"/*13*/,"logs/ghiran-1"/*14*/,
                                 "logs/darcy-1"/*15*/,"logs/blankenship-1"/*16*/,"logs/grossman-1"/*17*/,"logs/grossman-2"/*18*/,"logs/grossman-3"/*19*/,"shodan/shodan_laserisbeingreadied"/*20*/,"logs/stannek-2"/*21*/,"logs/anderczyk"/*22*/,"logs/endicott-1"/*23*/,"logs/wong-2"/*24*/,"logs/melville-1"/*25*/,"logs/baerga-1"/*26*/,"shodan/shodan_tocyborg43s"/*27*/,
                                 "logs/darcy-3"/*28*/,"logs/darcy-2"/*29*/,"logs/stannek-1"/*30*/,"logs/baerga-2"/*31*/,"shodan/shodan_energydrainmines"/*32*/,"shodan/shodan_drunkwithvisioniamgod"/*33*/,"logs/hayes-1"/*34*/,"logs/fortier-1"/*35*/,"logs/fortier-2"/*36*/,"logs/harvey-1"/*37*/,"logs/ghiran-3"/*38*/,"logs/ghiran-4"/*39*/,"logs/ghiran-5"/*40*/,
                                 "shodan/shodan_cyborg77e"/*41*/,"vox/vox_relay428failure"/*42*/,"logs/aubrey-1"/*43*/,"logs/aubrey-2"/*44*/,"logs/wong-1"/*45*/,"logs/macleod-1"/*46*/,"logs/sabo-1"/*47*/,"logs/macleod-2"/*48*/,"logs/macleod-3"/*49*/,"logs/diego-1"/*50*/,"logs/schuler-1"/*51*/,"logs/travers-3"/*52*/,"logs/travers-4"/*53*/,"logs/travers-2"/*54*/,
                                 "logs/kell-1"/*55*/, "logs/kell-2"/*56*/,"logs/travers-1"/*57*/, "shodan/shodan_cyborg65v"/*58*/,"logs/mcdaniel-1"/*59*/,"logs/mcdaniel-2"/*60*/,"logs/parovski-3"/*61*/,"logs/perry-1"/*62*/,"logs/koufax-1"/*63*/,"logs/wilkinson-1"/*64*/,"logs/diego-2"/*65*/,"shodan/shodan_grovesteps"/*66*/, "logs/aaron-1"/*67*/,"logs/aaron-2"/*68*/,
                                 "logs/diego-3"/*69*/,"logs/aaron-3"/*70*/,"logs/hessman-1"/*71*/,"logs/richie-1"/*72*/,"logs/schuler-2"/*73*/,"logs/schuler-3"/*74*/,"logs/schuler-4"/*75*/,"logs/hessman-2"/*76*/,"shodan/shodan_learnchildren"/*77*/,"shodan/shodan_level8layout"/*78*/,"logs/stevens-2"/*79*/,"logs/diego-4"/*80*/,"shodan/shodan_gaurdthrone"/*81*/,
                                 "logs/ghiran-6"/*82*/,"shodan/shodan1"/*83*/,"logs/rebecca-1"/*84*/,"shodan/shodan_whoareyou"/*85*/,"shodan/shodan_insectloose_plansforearth"/*86*/,"logs/parovski-1"/*87*/,"logs/parovski-2"/*88*/,"shodan/shodan_quietstation"/*89*/,"logs/rebecca-3"/*90*/,"shodan/shodan_iwilldownloadmyself"/*91*/,"shodan/shodan_imonthebridge"/*92*/,
                                 "logs/rebecca-4"/*93*/, "shodan/shodan_enjoyyourvictory"/*94*/,"cyborgs/ediego_dontkeepmewaiting"/*95*/,"shodan/shodan_youdestroyedmystation"/*96*/,"shodan/shodan_nomoretransmissions"/*97*/,"shodan/shodan_doyouthinkshecanhelp"/*98*/,"shodan/shodan_ceasepestering"/*99*/,"shodan/shodan_morrisbrocailisadolt"/*100*/,
                                 "shodan/shodan_shecanthelp"/*101*/,""/*102*/,""/*103*/,""/*104*/,""/*105*/,""/*106*/,""/*107*/,""/*108*/,"hud/vmailalert"/*109*/,""/*110*/,""/*111*/,"shodan/shodan_thankyou"/*112*/,"hud/vmailalert"/*113*/,""/*114*/,"hud/vmailalert"/*115*/,"hud/vmailalert"/*116*/,""/*117*/,"hud/vmailalert"/*118*/,"hud/vmailalert"/*119*/,""/*120*/,""/*121*/,
...
FootStepType GetFootstepTypeForPrefab(int pid) {
    ...
    if (!initialized) {
        ...
        const Range ranges[]={{0,0,FSTP_None},{21,22,FSTP_None},{2,10,FSTP_Squish},{98,100,FSTP_Squish},{110,110,FSTP_Squish},{13,18,FSTP_Metal2},{82,88,FSTP_Metal2},{23,40,FSTP_Plastic2},{48,49,FSTP_Plastic2},{53,53,FSTP_Plastic2},{41,47,FSTP_Plastic},{149,159,FSTP_Plastic},{64,66,FSTP_Sand},{94,96,FSTP_Grass},{101,109,FSTP_GrittyCrete},{111,111,FSTP_GrittyCrete},
                              {144,148,FSTP_Vent},{131,134,FSTP_Metal},{1,1,FSTP_Glass},{19,19,FSTP_Glass},{77,77,FSTP_Glass},{93,93,FSTP_Glass},{122,122,FSTP_Glass},{126,126,FSTP_Glass},{128,128,FSTP_Glass},{187,187,FSTP_Glass},{221,221,FSTP_Glass},{235,237,FSTP_Glass},{260,261,FSTP_Glass},{270,271,FSTP_Glass},{279,279,FSTP_Glass},{11,11,FSTP_Metpanel},{51,52,FSTP_Metpanel},
                              {56,57,FSTP_Metpanel},{71,71,FSTP_Metpanel},{116,117,FSTP_Metpanel},{120,121,FSTP_Metpanel},{135,136,FSTP_Metpanel},{139,140,FSTP_Metpanel},{204,207,FSTP_Metpanel},{458,460,FSTP_Metpanel},{477,479,FSTP_Metpanel},{12,12,FSTP_Marble},{61,61,FSTP_Marble},{72,73,FSTP_Marble},{76,76,FSTP_Marble},{280,287,FSTP_Marble},{20,20,FSTP_Wood2},
...
const char* RustleSound() { return sounds[random_range_u32(459,465)]; } // footsteps/Clothes/rustle01..07 (idle clothes scuff)
    ...
    i32 WINAPI CoInitializeEx(void*,u32); i32 WINAPI CoCreateInstance(const GUID*,IUnknown*,u32,const GUID *const,void**); static wasapi_dev_t wasapi_devs[8]; static int wasapi_dev_count = 0;
    ...
    static int wasapi_init_device(IMMDevice *dev,int r,int ch,int period_frames,int p) {
        if(wasapi_dev_count>=8){return -1;} wasapi_dev_t *w=&wasapi_devs[wasapi_dev_count]; i32 hr=dev->lpVtbl->Activate(dev,&IID_IAudioClient,23,NULL,(void**)&w->client); if(((i32)(hr)<0)){DualLogError("WASAPI Activate failed, %u\n",hr); return -1;}
        WAVEFORMATEX fmt = {1,(u16)ch,(u32)r,(u32)(r*ch*2),(u16)(ch*2),16,0}; i64 buf_dur = (i64)(period_frames*p)*10000000LL/r; hr = w->client->lpVtbl->Initialize(w->client,0,524288,buf_dur,0,&fmt,NULL); if(((i32)(hr)<0)){w->client->lpVtbl->Release(w->client); return -1;}
        w->client->lpVtbl->GetBufferSize(w->client,&w->buffer_frames); hr = w->client->lpVtbl->GetService(w->client,&IID_IAudioRenderClient,(void**)&w->render); if(((i32)(hr)<0)){ w->client->lpVtbl->Release(w->client); return -1;} w->client->lpVtbl->Start(w->client);w->rate=r; w->channels=ch; w->period_frames=period_frames; w->open=true; return wasapi_dev_count++;
    }
    ...
    static FHandle pcm_open_all(int rate,int channels,int period_frames,int periods) {
        CoInitializeEx(NULL,0); IMMDeviceEnumerator *en = NULL; if (((i32)(CoCreateInstance(&CLSID_MMDeviceEnumerator_,NULL,23,&IID_IMMDeviceEnumerator_,(void**)&en))<0)) { DualLogError("CoCreateInstance fail\n"); return INVALID_FHANDLE; }
        IMMDevice *dev = NULL; i32 hr = en->lpVtbl->GetDefaultAudioEndpoint(en,0,0,&dev); en->lpVtbl->Release(en); if (((i32)(hr)<0)||!dev) return INVALID_FHANDLE; int idx = wasapi_init_device(dev,rate,channels,period_frames,periods); dev->lpVtbl->Release(dev); if (idx<0) return INVALID_FHANDLE; return ((FHandle)(intptr_t)100);
    }

    int pcm_sync(FHandle fd, pcm_sync_t *sync) { int idx=((int)(intptr_t)(fd)-100); if(idx<0||idx>=wasapi_dev_count||!wasapi_devs[idx].open){return -1;} wasapi_dev_t *w=&wasapi_devs[idx]; u32 padding=0; w->client->lpVtbl->GetCurrentPadding(w->client,&padding); snd_pcm_uframes_t base = (w->buffer_frames>(u32)(w->period_frames*4)) ? w->buffer_frames-(u32)(w->period_frames*4) : 0; sync->status.hw_ptr=base; sync->control.appl_ptr=base+padding; return 0; }
    int pcm_prepare(FHandle fd) { int i=((int)(intptr_t)(fd)-100); if (i < 0 || i >= wasapi_dev_count) return -1; wasapi_dev_t *w = &wasapi_devs[i]; return w->client->lpVtbl->Stop(w->client),w->client->lpVtbl->Reset(w->client),w->client->lpVtbl->Start(w->client), 0; }
    int pcm_write(void *buf, int frames) { for (int i=0;i<wasapi_dev_count;i++) { wasapi_dev_t *w=&wasapi_devs[i]; if(!w->open){continue;} u8* data = NULL; if(((i32)(w->render->lpVtbl->GetBuffer(w->render,(u32)frames,&data))<0)){pcm_prepare(((FHandle)(intptr_t)((i)+100))); continue;} mcpy(data,buf,frames*w->channels*2); w->render->lpVtbl->ReleaseBuffer(w->render,(u32)frames,0); } return frames; }
#else
...
static __attribute__((noinline)) float mp3L3_pow_43(int x) { if(x<129){return g_mp3_pow43[16+x];} int mult=256; if(x<1024){mult=16; x<<=3;} int sign=2*x&64; float frac=(float)((x&63)-sign)/((x&~63)+sign); return g_mp3_pow43[16+((x+sign)>>6)]*(1.f+frac*((4.f/3)+frac*(2.f/9)))*mult; }
static __attribute__((noinline)) void mp3L3_huffman(float *dst, mp3_bs *bs, const mp3L3_gr_info *gr_info, const float *scf, int layer3gr_limit) {
            ...
            do {
                ...
                do {
                    ...
                    for (j=0;j<2;j++,dst++,leaf>>=4){
                        int lsb=leaf&0x0F; 
                        if (lsb==15) { lsb += (bs_cache>>(32-(linbits))); MP3_FLUSH_BITS(linbits); while(bs_sh>=0){bs_cache|=(u32)*bs_next_ptr++<<bs_sh;bs_sh-=8;}; *dst= one * mp3L3_pow_43(lsb) * ((i32)bs_cache < 0 ? -1 : 1); } else *dst=g_mp3_pow43[16+lsb-16*(bs_cache>>31)]*one;
...
static __attribute__((noinline)) void mp3L3_imdct36(float *grbuf, float *overlap, const float *win, int nbands) {
    ...
    for (j=0;j<nbands;j++,grbuf+=18,overlap+=9){
        float co[9],si[9]; co[0]=-grbuf[0]; si[0]=grbuf[17]; for(i=0;i<4;i++){si[8-2*i]=grbuf[4*i+1]-grbuf[4*i+2];co[1+2*i]=grbuf[4*i+1]+grbuf[4*i+2];si[7-2*i]=grbuf[4*i+4]-grbuf[4*i+3];co[2+2*i]=-(grbuf[4*i+3]+grbuf[4*i+4]);}
        mp3L3_dct3_9(co); mp3L3_dct3_9(si); si[1]=-si[1];si[3]=-si[3];si[5]=-si[5];si[7]=-si[7]; i=0;
...
static __attribute__((noinline)) void mp3L3_idct3(float x0,float x1,float x2,float *dst){float m1=x1*0.86602540f,a1=x0-x2*0.5f;dst[1]=x0+x2;dst[0]=a1+m1;dst[2]=a1-m1;}
static __attribute__((noinline)) void imdct12(float *x,float *dst,float *overlap){
    static const float g_twid3[6]={0.79335334f,0.92387953f,0.99144486f,0.60876143f,0.38268343f,0.13052619f}; float co[3],si[3]; int i; mp3L3_idct3(-x[0],x[6]+x[3],x[12]+x[9],co); mp3L3_idct3(x[15],x[12]-x[9],x[6]-x[3],si); si[1]=-si[1];
...
static __attribute__((noinline)) void mp3L3_imdct_short(float *grbuf,float *overlap,int nbands){ for(;nbands>0;nbands--,overlap+=9,grbuf+=18){float tmp[18]; mcpy(tmp,grbuf,sizeof(tmp)); mcpy(grbuf,overlap,6*sizeof(float)); imdct12(tmp,grbuf+6,overlap+6); imdct12(tmp+1,grbuf+12,overlap+6); imdct12(tmp+2,overlap,overlap+6);} }
static __attribute__((noinline)) void mp3L3_change_sign(float *grbuf){int b,i;for(b=0,grbuf+=18;b<32;b+=2,grbuf+=36)for(i=1;i<18;i+=2)grbuf[i]=-grbuf[i];}
...
typedef struct mp3_channel_s { mp3 dec; bool open; u32 src_rate; _Atomic u64 frames_decoded; u64 total_frames; _Atomic float fade_vol,fade_target,fade_step; struct mp3_channel_s *next; } mp3_channel_t; typedef struct log_msg_s { float *samples; size_t allocSize; u32 frame_count,frame_pos; struct log_msg_s *next; } log_msg_t;
...
static float rev_buf[4][REV_BUF_LEN]/*4 comb delay lines, ~1.7MB static*/, ap_buf[2][3533];/*2 allpass lines, prime lengths*/
static u32   rev_idx[4], ap_idx[2], rev_len[4];/*per-comb delay length in samples*/
static float rev_fb[4]/*per-comb feedback gain (set by synth_set_room)*/, rev_lp[4]/*per-comb LP filter state (damps high freqs in tail)*/, rev_wet=0.20f, rev_dry=1.00f;
static const u32 REV_BASE[4] = { 1373, 1607, 1931, 2269 }; // Base delay lengths (small room). Scaled up for larger spaces. Chosen as mutually prime to prevent periodicity artifacts.
static const u32 AP_LEN[2]   = { 379, 547 }; // Allpass delay lengths — fixed, short for diffusion not coloration.
void synth_set_room(float sz, float wet) { //   synth_set_room(0.0f,  0.00f);  // anechoic (outdoor, dead room)   synth_set_room(0.25f, 0.20f);  // small corridor / panel room   synth_set_room(0.45f, 0.30f);  // medium room / storage bay   synth_set_room(0.70f, 0.45f);  // large open area / hangar   synth_set_room(0.88f, 0.55f); cave / underground. 0.3(dead) 0.92(cave), sz 0..1 scales delay lengths from base (small) up to ~5x (cave).*/
    float scale=1.0f + sz*4.0f; float fb=0.3f + sz*0.62f; for (u32 i=0;i<4;++i){u32 len=(u32)(REV_BASE[i]*scale); if(len>=REV_BUF_LEN){len=REV_BUF_LEN-1;} rev_len[i]=len; rev_fb[i]=fb*(0.97f+i*0.007f);/*slight spread across combs*/ rev_lp[i]=0.0f; rev_idx[i]=0;} ap_idx[0]=ap_idx[1]=0; rev_wet=wet; rev_dry=1.0f;
}

static float reverb_tick(float in) { // Process one sample through the reverb network. Call after all voices mixed.
    float comb_sum = 0.0f; for (u32 i = 0; i < 4; i++) { float delayed = rev_buf[i][rev_idx[i]]; rev_lp[i] += 0.5f * (delayed - rev_lp[i]); rev_buf[i][rev_idx[i]] = in + rev_lp[i] * rev_fb[i]; rev_idx[i] = (rev_idx[i] + 1 >= rev_len[i]) ? 0 : rev_idx[i] + 1; comb_sum += delayed; } // 4 parallel comb filters.  LP inside feedback loop — damps highs each reflection, like real walls
    comb_sum *= 0.25f; for (u32 i = 0; i < 2; i++) { float delayed = ap_buf[i][ap_idx[i]]; float w = comb_sum + delayed * 0.5f; ap_buf[i][ap_idx[i]] = w; ap_idx[i] = (ap_idx[i] + 1 >= AP_LEN[i]) ? 0 : ap_idx[i] + 1; comb_sum = delayed - 0.5f * w; } /*2 serial allpass diffusers — smear the echo pattern into smooth tail*/ return comb_sum;
}
...
static float GenClink(SynthVoice* v) { float t = (float)v->frame / AUDIO_RATE; return vsinf(6.28318f * v->p[0]*v->pitch * t) * vexp(-v->p[1]*t); } // p[0]=freq  p[1]=decay
...
static const SynthPreset SynthPresets[SND_COUNT] = {[SND_LASER_PISTOL]={GenLaserSS1,0.30f,0.55f,{900.0f,-1.8f,0.5f,10.0f}},[SND_LASER_RIFLE]={GenLaserSS1,0.40f,0.70f,{600.0f,-0.8f,0.4f,7.0f}},[SND_DOOR]={GenDoor,1.20f,0.65f,{50.0f,0,0,0}},[SND_IMPACT_GLASS]={GenImpact,0.50f,0.60f,{4500.0f,18.0f,0.3f,0.6f}},
                                                    [SND_IMPACT_METAL]={GenImpact,0.50f,0.65f,{1800.0f,30.0f,0.5f,0.3f}},[SND_EXPLOSION]={GenBoom,1.00f,0.80f,{55.0f,3.5f,0,0}},[SND_HISS]={GenHiss,1.50f,0.35f,{0.12f,0,0,0}},[SND_PIPE]={GenPipe,1.50f,0.40f,{0.07f,0,0,0}},[SND_SHIELD_HIT]={GenShieldHit,0.35f,0.50f,{180.0f,8.0f,0,0}},
                                                    [SND_FOOTSTEP]={GenFootstep,0.26f,0.70f,{0}},[SND_SAND_FOOTSTEP]={GenSandFootstep,0.30f,0.65f,{0}},[SND_TAP_CASE]={GenTapCase,0.25f,0.55f,{0}},[SND_PLASTIC_TAP]={GenPlasticTap,0.09f,0.50f,{0}},[SND_SPARK_SMALL]={GenSparkSmall,0.24f,0.50f,{0}},
                                                    [SND_CRACKLE]={GenCrackle,2.00f,0.45f,{0.28f,2.5f,20.0f,0}},[SND_SINE]={GenSine,1.00f,0.50f,{440.0f,0,0,0}},[SND_CLINK]={GenClink,0.40f,0.50f,{1200.0f,12.0f,0,0}},[SND_BEAKER_CLINK]={GenRing,1.20f,0.50f,{2400.0f,4.0f,1.4f,0.008f}},[SND_BEAKER_THUD]={GenBeakerThud,0.60f,0.55f,{2200.0f,18.0f,0.06f,0.012f}}};
void play_synth(SoundID id, float vol, float pitch){if((u32)id >= SND_COUNT){return;} const SynthPreset* pr=&SynthPresets[id]; SynthVoice* v=SynAlloc(); if(!v){return;} *v=(SynthVoice){.fn=pr->fn,.frames=(u32)(AUDIO_RATE*pr->dur),.vol=pr->vol*vol,.pitch=pitch,.active=true}; v->p[0]=pr->p[0]; v->p[1]=pr->p[1]; v->p[2]=pr->p[2]; v->p[3]=pr->p[3];}
...
static void mp3_ch_retire(i32 s, mp3_channel_t *old) { if (!old){return;} mp3_channel_t *head = __c11_atomic_load(&mp3_ch_retired[s],0/*memorder_relaxed*/); do { old->next = head; } while (!__c11_atomic_compare_exchange_weak(&mp3_ch_retired[s],&head,old,3/*memorder_release*/,0/*memorder_relaxed*/)); }
static void mp3_ch_finish(i32 s, mp3_channel_t *cur){ mp3_channel_t *expected=cur; if(__c11_atomic_compare_exchange_strong(&mp3_ch[s],&expected,NULL,4/*memorder_acq_rel*/,0/*memorder_relaxed*/)){mp3_uninit(&cur->dec); OS_Free(cur,sizeof(*cur));} }
static void audio_mix_period(i16 *out) {
    for (i32 s=0;s<2;s++) { mp3_channel_t *r = __c11_atomic_exchange(&mp3_ch_retired[s],NULL,2/*memorder_acquire*/); while (r) { mp3_channel_t *n = r->next; mp3_uninit(&r->dec); OS_Free(r,sizeof(*r)); r = n; } }
    log_msg_t *lr = __c11_atomic_exchange(&log_msg_retired,NULL,2/*memorder_acquire*/); while (lr) { log_msg_t *n = lr->next; OS_Free(lr->samples,lr->allocSize); OS_Free(lr,sizeof(*lr)); lr = n; } float mix[AUDIO_FRAMES*AUDIO_CHANNELS]; mset(mix,0,sizeof(mix));
    ...
    for (u32 c=0;c<MAX_SYNTH_VOICES;c++) if (syn_ch[c].active) synth_mix(&syn_ch[c],mix); synth_reverb_apply(mix, AUDIO_FRAMES); {log_msg_t *lm = __c11_atomic_load(&log_msg,2/*memorder_acquire*/);
    if (lm) {
        float vol = (Sys_Settings.VolumeMaster/100.0f)*(Sys_Settings.VolumeMessage/100.0f);
        for(i32 f=0;f<AUDIO_FRAMES;++f){if(lm->frame_pos>=lm->frame_count){log_msg_t *e=lm; if(__c11_atomic_compare_exchange_strong(&log_msg,&e,NULL,4/*memorder_acq_rel*/,0/*memorder_relaxed*/)){OS_Free(lm->samples,lm->allocSize); OS_Free(lm,sizeof(*lm));} break;} mix[f*2+0]+=lm->samples[lm->frame_pos*2+0]*vol; mix[f*2+1]+=lm->samples[lm->frame_pos*2+1]*vol; lm->frame_pos++;}
    } }
    if (!__c11_atomic_load(&mp3_paused,0/*memorder_relaxed*/)) {
        for (u32 s = 0; s < 2; s++) {
            mp3_channel_t *m = __c11_atomic_load(&mp3_ch[s],2/*memorder_acquire*/);
            if (!m || !m->open) { __c11_atomic_store(&mp3_remaining[s],0.0f,0/*memorder_relaxed*/); continue; }
            if (__c11_atomic_exchange(&mp3_fade_out_target[s],NULL,2/*memorder_acquire*/) == m) { i32 fms = __c11_atomic_load(&mp3_fade_out_ms[s],0/*memorder_relaxed*/); float curvol = __c11_atomic_load(&m->fade_vol,0/*memorder_relaxed*/); __c11_atomic_store(&m->fade_step,(fms>0) ? -curvol/(AUDIO_RATE*fms/1000.0f) : -1.0f,0/*memorder_relaxed*/); __c11_atomic_store(&m->fade_target,0.0f,0/*memorder_relaxed*/); }
            ...
            u64 got = mp3_read_pcm_frames_f32(&m->dec,frames_to_read,raw); if (got == 0) { __c11_atomic_store(&mp3_remaining[s],0.0f,0/*memorder_relaxed*/); mp3_ch_finish(s,m); continue; }
            float fade_vol = __c11_atomic_load(&m->fade_vol,0/*memorder_relaxed*/); float fade_target = __c11_atomic_load(&m->fade_target,0/*memorder_relaxed*/); float fade_step = __c11_atomic_load(&m->fade_step,0/*memorder_relaxed*/); 
            float vol = fade_vol * (Sys_Settings.VolumeMaster/100.0f)*(Sys_Settings.VolumeMusic/100.0f); u64 decoded = __c11_atomic_load(&m->frames_decoded,0/*memorder_relaxed*/) + got; __c11_atomic_store(&m->frames_decoded,decoded,0/*memorder_relaxed*/); float ratio = (float)got/(float)AUDIO_FRAMES; bool finished=false;
            ...
            __c11_atomic_store(&m->fade_vol,fade_vol,0/*memorder_relaxed*/); __c11_atomic_store(&m->fade_step,fade_step,0/*memorder_relaxed*/); float rem = (!m->total_frames || decoded >= m->total_frames) ? 0.0f : (float)(m->total_frames - decoded) / (float)(m->src_rate ? m->src_rate : AUDIO_RATE);
            __c11_atomic_store(&mp3_remaining[s], rem, 0/*memorder_relaxed*/); if (finished) { __c11_atomic_store(&mp3_remaining[s],0.0f,0/*memorder_relaxed*/); mp3_ch_finish(s,m); }
        }
    }
...
void play_wav(const char *path,float volume,V3 pos,bool positional) {
    ...
    char p[128]; sFormat(p,sizeof(p),"./Audio/%s.wav",path); i32 slot=GetFreeWavSlot(); if(slot==-1){u32 cur=__c11_atomic_load(&wav_count,2/*acquire*/); if(cur < MAX_CHANNELS){slot=(i32)__c11_atomic_fetch_add(&wav_count,1u,3/*release*/);}} if(slot==-1){DualLogWarn("Max WAV channels (%d) reached\n",MAX_CHANNELS); return;}
...
void play_message(const char *path) {
    ...
    lm->frame_pos = 0; log_msg_t *old = __c11_atomic_exchange(&log_msg,lm,3/*memorder_release*/); if (old) { log_msg_t *head = __c11_atomic_load(&log_msg_retired,0/*memorder_relaxed*/); do { old->next = head; } while (!__c11_atomic_compare_exchange_weak(&log_msg_retired,&head,old,3/*memorder_release*/,0/*memorder_relaxed*/)); }
}
...
static void mp3_open_slot(i32 s, const char *path, float fade_from, float fade_to, i32 fade_ms) {
    ...
    __c11_atomic_store(&m->fade_vol, step == 0.0f ? fade_to : fade_from, 0/*memorder_relaxed*/);
    __c11_atomic_store(&m->fade_target, fade_to, 0/*memorder_relaxed*/);
    __c11_atomic_store(&m->fade_step, step, 3/*memorder_release*/);
    __c11_atomic_store(&mp3_remaining[s], (!m->total_frames) ? 1.0f : (float)m->total_frames / (float)(m->src_rate ? m->src_rate : AUDIO_RATE), 0/*memorder_relaxed*/);
    mp3_ch_retire(s, __c11_atomic_exchange(&mp3_ch[s], m, 3/*memorder_release*/));
}

void play_mp3(const char *path, i32 fade_ms) { i32 old = mp3_slot, next = mp3_slot ? 0 : 1; mp3_channel_t *cur = __c11_atomic_load(&mp3_ch[old],0/*memorder_relaxed*/); if (cur) { __c11_atomic_store(&mp3_fade_out_ms[old], fade_ms, 0/*memorder_relaxed*/); __c11_atomic_store(&mp3_fade_out_target[old], cur, 3/*memorder_release*/); } mp3_slot = next; mp3_open_slot(next,path,0.0f,1.0f,fade_ms); }
void mp3_clear() { for (i32 i=0;i<2;i++) mp3_ch_retire(i, __c11_atomic_exchange(&mp3_ch[i],NULL,3/*memorder_release*/)); mp3_slot=0; }
static FHandle pcm_fds[8]; static i32 pcm_fd_count = 0; pthread_t audThreadID; void* AudThread(void* arg); 
#if defined(_WIN32)
    void AudioUpdate() {
...
void UpdateMusic() {
    if ((World.paused && !World.menuActive) || !Sys_Settings.VolumeMusic) { __c11_atomic_store(&mp3_paused,true,0/*memorder_relaxed*/); return; }
    __c11_atomic_store(&mp3_paused,false,0/*memorder_relaxed*/);
    float remaining = __c11_atomic_load(&mp3_remaining[mp3_slot],2/*memorder_acquire*/);
