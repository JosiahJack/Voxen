...
CC=gcc
export LD=mold
CFLAGS="-pipe -fno-ident -fno-asynchronous-unwind-tables -fstack-protector-all -fdata-sections -ffunction-sections -g0 -fstrict-aliasing -Wstrict-aliasing=2 -fno-common -std=c11 -Wall -Wextra -Werror -Wdouble-promotion -Wformat=2 -Wshadow -Wnull-dereference -Wno-overlength-strings -Og -D_GNU_SOURCE"
