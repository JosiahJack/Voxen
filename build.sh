...
CC=gcc
CFLAGS="-fopenmp -std=c11 -Wall -Wextra -Wno-implicit-function-declaration -O3 -D_POSIX_C_SOURCE=199309L"
LDFLAGS="-L./External -l:libassimp.6.0.2.a -lz -lstdc++ -static-libstdc++ -l:libglfw3.4.a -l:libminiaudio.0.11.22.a -lGLEW -lGL -lm -lrt -lenet -lpthread -lfontconfig -fopenmp"
