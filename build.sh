...
SOURCES="voxen.c physics.c entity.c lib.c citadel.c weapons.c text.c audio.c textures.c models.c biomonitor.c culling.c particles.c" #synth.c is in audio.c
