...
CC=gcc
export LD=mold
CFLAGS="-flto -pipe -fno-ident -fno-asynchronous-unwind-tables -fstack-protector-all -fdata-sections -ffunction-sections -g0 -fopenmp -std=c11 -Wall -Wextra -Og"
# LDFLAGS="-fuse-ld=mold -Wl,--gc-sections -flto -L./External -l:libz.a -static-libstdc++ -static-libgcc -l:libglfw3.5.a -l:libminiaudio.0.11.22.a -ffast-math -lGL -lfontconfig -fopenmp" # Uncomment for compiling with FONT_GEN set to regenerate font atlases
LDFLAGS="  -fuse-ld=mold -Wl,--gc-sections -flto -L./External -l:libz.a -static-libstdc++ -static-libgcc -l:libglfw3.5.a -l:libminiaudio.0.11.22.a -ffast-math -lGL              -fopenmp"
...
export CC=gcc
export CFLAGS="-pipe -fno-ident -fno-asynchronous-unwind-tables -fstack-protector-all -g0 -fopenmp -std=c11 -Wall -Wextra -Og"
export TEMP_DIR=temp_build
printf "%s\n" $SOURCES | xargs -P12 -I{} $CC -c {} $CFLAGS -o "$TEMP_DIR"/{}.o
cp ./External/assimp/*.o "$TEMP_DIR"/
g++ "$TEMP_DIR"/*.o -o voxen $LDFLAGS
link_status=$?
